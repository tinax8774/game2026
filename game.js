...
class Level2 extends Phaser.Scene {
    ...
    create() {
        ...
        let wall = floor.create(600, 135, "groundOne").setScale(0.3, 3).refreshBody();
...
const config = {
    ...
    width: 800,
    height: 636,
    scene: [StartScene, CharacterScene, InstructionScene, HomeScene, CreditsScene, Level1, Level2, Level3],
