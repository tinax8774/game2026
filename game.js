    ...
    create() {
        ...
        this.chemQuestions = {
            ...
            7: [
                ...
                { q: "A student observes that Q = K at a single instant. What can be concluded with certainty?", a: "c", options: {a: "A system has been at equilibrium for a long time", b: "The system will not shift", c: "The system is at equilibrium at that constant", d: "The reaction has stopped"}, exp: "Adding reactant guarantees a disturbance, but observing that both equilibrium concentrations increased does not uniquely determine reaction enthalpy, Δn, or a change in K. Temperature was not stated to change, so K cannot be assumed to increase. Multiple reaction types can show this outcome depending on stoichiometry. This is a classic 'tempting inference' trap." },
                { q: "A system is at equilibrium. Reactants are added, but equilibrium concentrations of both reactants and products increase after re-equilibration. Which conclusion is logically valid?", a: "d", options: {a: "The reaction is endothermic", b: "ΔN > 0", c: "K increased", d: "None of the above"}, exp: "A small K indicates reactant-favored equilibrium. K does not provide information about rate, enthalpy, or whether products form at all. Products still exist-just in smaller amounts." },
                { q: "A reaction has K=1.0*10^-3 at 25°C. Which statement must be true?", a: "b", options: {a: "The reaction is slow", b: "Reactants dominate at equilibrium", c: "Products never form", d: "The reaction is exothermic"}, exp: "Reaching the same equilibrium regardless of starting conditions demonstrates that equilibrium is determined by thermodynamics (K), not kinetics. This eliminates ideas about rate or activation energy and focuses on the defining nature of equilibrium." },
                { q: "Which conclusion can be drawn if a reaction reaches the same equilibrium composition from three different starting mixtures?", a: "d", options: {a: "Reaction is fast", b: "Reaction is endothermic", c: "Equilibrium is kinetically controlled", d: "Equilibrium position is thermodynamically defined"}, exp: "Adding reactant increases the denominator of the reaction quotient expression, immediately lowering Q. At that instant, the system has not yet had time to shift, so K is unchanged while Q has decreased. Therefore Q < K." },
                { q: "A system is at equilibrium. A student adds reactant and immediately measures concentrations before any shift occurs. Which statement must be true at that instant?", a: "b", options: {a: "Q = K", b: "Q < K", c: "Q > K", d: "Equilibrium has shifted"}, exp: "If both experiments are conducted at the same temperature for the same reaction, the equilibrium constant K must be the same. Different equilibrium compositions can result from different initial conditions or disturbances, but K itself is unchanged." },
                { q: "Two experiments of the same reaction are conducted at the same temperature. Both reach equilibrium, but Experiment 1 has a larger product-to-reactant ratio than Experiment 2. Which conclusion is valid?", a: "d", options: {a: "Experiment 1 has a larger K", b: "Experiment 2 has a larger K", c: "The two experiments must have different K values", d: "Neither experiment changed K"}, exp: "Flat(horizonal) regions on concentration-time graphs indicate that concentrations are no longer changing with time. This occurs when the forward and reverse reaction rates are equal which defines equilibrium." },
                { q: "A concentration-time graph shows reactant concentration decreasing smoothly and then becoming constant, while product reactant increases and then becomes constant. What does the flat portion of both curves  indicate?", a: "c", options: {a: "Reaction completion", b: "Equal concentrations", c: "Equilibrium has been reached", d: "Reaction rate is zero"}, exp: "Removing a reactant directly changes concentration and shifts equilibrium. Adding inert gas at constant volume does not change concentrations or partial pressure, not concentration alone. This question isolates concentration effects from pressure effects." },
                { q: "Which change causes an equilibrium shift only because concentrations change, not because pressure changes?", a: "d", options: {a: "Compressing a gas mixture", b: "Adding inert gas at constant pressure", c: "Adding inert gas at constant volume", d: "Removing a reactant from solution"}, exp: "When a system starts with only reactants, no products are present initially, so the reverse reaction cannot occur at first. As soon as products begin forming, the reverse rate increases, but until equilibrium is reached, the forward rate remains greater than the reverse rate." },
                { q: "A reaction mixture is prepared with reactants only and then sealed at constant temperature. Which statement must be true before equilibrium is reached?", a: "c", options: {a: "Product concentration remains zero", b: "Reverse reaction rate is greater than forward rate", c: "Forward reaction rate is greater than reverse rate", d: "Concentrations remain constant"}, exp: "Endothermic reactions absorb heat. Increasing temperature favors product formation and shifts equilibrium right, resulting in a larger equilibrium constant. Only temperature affects the numerical value of KKK." },
                { q: "Which change will increase the value of KKK for an endothermic reaction?", a: "b", options: {a: "Decreasing temperature", b: "Increasing temperature", c: "Adding catalyst", d: "Increasing pressure"}, exp: "Since Q>KQ>KQ>K, the system has too many products relative to reactants. To re-establish equilibrium, the reaction proceeds in the reverse direction, forming more reactants and decreasing product concentration until Q=KQ=KQ=K. The reaction does not stop; it dynamically shifts until equilibrium is restored." },
                { q: "If a reaction mixture has Q=4.5 Q=4.5 Q=4.5 and K=1.2 K=1.2 K=1.2, what will occur?", a: "b", options: {a: "The reaction will shift right", b: "The reaction will shift left", c: "The reaction is at equilibrium", d: "The reaction will stop"}, exp: "A catalyst lowers activation energy equally for forward and reverse reactions, allowing equilibrium to be reached faster without changing the equilibrium concentrations. In contrast, changes in concentration, pressure (for gases), or temperature alter system stress and cause equilibrium shifts." },
                { q: "Which change will not shift the equilibrium position of a system?", a: "c", options: {a: "Changing concentration", b: "Changing temperature", c: "Adding a catalyst", d: "Changing pressure (gaseous system)"}, exp: "At dynamic equilibrium, the forward and reverse reactions continue to occur at equal rates, so the overall concentrations remain constant over time" },
                { q: "What does it mean for a chemical reaction to be at dynamic equilibrium?", a: "b", options: {a: "The reaction has stopped completely", b: "The forward and reverse reactions occur at the same rate", c: "The concentrations of reactants and products are equal", d: "Only products are present"}, exp: "Constant concentrations over time indicate equilibrium has been reached, even if the reactions are still occuring." },
                { q: "Which observation indicates that a chemical system has reached equilibrium?", a: "c", options: {a: "Concentrations of all species becomes zero", b: "Gas bubbles are no longer produced", c: "The concentrations of all species remain constant over time", d: "The reaction mixture becomes colorless"}, exp: "Removing NH_3 reduces product concentration. THe system shifts right to produce more NH_3 and restore balance." },
                { q: "For the reaction: N_2(g)+3H_2(g)<-->2NH_3(g)+heat  Which change will shift the equilibrium to the right?", a: "b", options: {a: "Increasing temperature", b: "Removing NH_3", c: "Decreasing pressure", d: "Adding a catalyst"}, exp: "Adding heat to an exothermic reaction favors the reverse (endothermic) direction, shifting equilibrium toward the reactants." },
                { q: "In the exothermic reaction: 2NO(g)+O_2(g)<-->2NO-2(g), which happens if temperature is increased?", a: "c", options: {a: "Equilibrium shifts right", b: "No change occurs", c: "Equilibrium shifts left", d: "The reaction stops"}, exp: "Pressure affects only gas-phase equilibria and shifts toward the side with fewer moles of gas." },
                { q: "A student says that increasing pressure always favors the product side. Is this true?", a: "c", options: {a: "Yes, pressure increases always favor products", b: "No, pressure only affects solids", c: "No, it depends on the number of moles of gas", d: "Yes, if the reaction is exothermic"}, exp: "This reaction shows the formation of ammonia. A general reaction would be aA+bB<-->cC+dD. Since all the reactants and products are gas particles, they will be included in the equilibrium expression which is expressed by Kc=(C)^c(D)^d/(A)^a(B)^b." },
                { q: "N_2(g)+3H_2(g)<-->2NH_3(g), Give the reaction above, what is the equilibrium constant, Kc?", a: "c", options: {a: "Kc=[N_2][H_2]^3/[2NH_3]^2", b: "Kc=[NH_3]/[H_2][N_2]", c: "Kc=[NH_3]^2/[H_2]^3[N_2]", d: "Kc=[N_2][H_2]/[NH_3]"}, exp: "The equilibrium can be affected by the total number of gas moles. In the provided reactions, choice a is the only answer with a different number of gas moles in reactant and product." },
                { q: "At a constant temperature, which of the following reactions would be affected from a change in pressure?", a: "a", options: {a: "2SO_2(g)+O_2(g)<-->2SO_3(g)", b: "N_2(g)+H_2(g)<-->2NH_3(g)", c: "2HI(g)<-->H-2(g)+I_2(g)", d: "2NO(g)<-->N_2(g)+O_2(g)"}, exp: "" },
                { q: "At a constant temperature, an increase in pressure would lead to an increase in product for which of the following reactions?", a: "c", options: {a: "2NO(g)<-->N_2(g)+O_2(g)", b: "H_2(g)+CO_2(g)<-->H_2O(g)+CO(g)", c: "CO(g)+Cl_2(g)<-->COCl_2(g)", d: "2N_2O_5<-->4NO_2(g)+O_2(g)"}, exp: "" },
                { q: "CaCO_3(g)+energy<-->CaO(s)+CO_2(g), The given reaction above takes place in a container. Given the reaction, which of the following changes would lead to an increase in the concentration of CO_2(g)?", a: "a", options: {a: "An increase in temperature", b: "A decrease in temperature", c: "An increase in container", d: "A decrease in container"}, exp: "" },
                { q: "H_2(g)+I_2(g)<-->2HI ΔH=58 kJ/mol, The reaction provided is in an equilibrium at 25°C. What is the expression of the equilibrium constant for the reaction?", a: "a", options: {a: "Kc=[H_2][I_2]/[HI]^2", b: "Kc=[HI]^2/[H_2][I_2]", c: "Kc=[HI]/[H_2][I_2]", d: "Kc=[H_2][I_2]/[HI]"}, exp: "" },
                { q: "Which of the following changes would affect the reverse reaction to speed up?", a: "b", options: {a: "Increase the temperature", b: "Decrease the temperature", c: "Increase the concentration of I_2", d: "Decrease the pressure"}, exp: "" },
                { q: "Which of the following would lead to a reduction in the value of the equilibrium constant?", a: "a", options: {a: "Decrease the temperature", b: "Increase the temperature", c: "Increase the concentration of I_2", d: "Decrease the pressure"}, exp: "" },
                { q: "The value of the Kc is 5.0. Which of the following would result in order to reach equilibrium if the initial concentration of all three species is 3.0?", a: "b", options: {a: "No change would occur", b: "The rate of forward reaction will increase", c: "The rate of reverse reaction will increase", d: "Both sides of the reaction will increase"}, exp: "" },
                { q: "2NO(g)<-->N_2(g)+O_2(g) From the reaction given above, what is the expression of the equilibrium constant, Kp?", a: "a", options: {a: "Kp=(O_2)(N_2)/(NO)^2", b: "Kp=(O^2)(N^2)/(NO)", c: "Kp=(NO)^2/(O_2)(N_2)", d: "Kp=(NO)/(O_2)(N_2)"}, exp: "" },
                { q: "The reaction provided above has reached equilibrium at a certain temperature. During that time, the partial pressure due to No has 3 atmospheres, the partial pressure due to N_2 has 2 atmospheres, and the partial pressure due to O_2 was 3 atmospheres. What is the value of the equilibrium constant, Kp?", a: "b", options: {a: "1/3", b: "2/3", c: "1", d: "2"}, exp: "" },
                { q: "The Ksp value of AgBr is 7.7*10^-13. Which of the following is equal to the solubility of AgBr?", a: "c", options: {a: "7.7*10^-13 molar", b: "5.9*10^-25 molar", c: "8.8*10^-7 molar", d: "3.8*10^-13 molar"}, exp: "" },
                { q: "Pb 2+(aq)+Zn 2+(s) <-->Pb(s)+Zn 2+(aq) Keq=3*10^30. A student performed an experiment where he put a 0.20 mol sample of solid zinc into a 500mL solution of 1.0M PbSO_3(aq). After a long period of time, what would be a possible result?", a: "d", options: {a: "Half of the concentration of zinc solid remains", b: "One-third of the concentration of Zn solid remains", c: "All of the concentration of Zn solid remains", d: "None of the concentration of Zn solid remains"}, exp: "" },
                { q: "The solubility of AgI is 8.0*10^-17. What is the solubility product constant Ksp, for AgI?", a: "d", options: {a: "1.6*10^-16", b: "8.9*10^-9", c: "8*10^-17", d: "6.4*10^-33"}, exp: "" }
            ],
            8: [
