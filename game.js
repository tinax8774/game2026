    ...
    create() {
        ...
        this.chemQuestions = {
            1: [
                ...
                { q: "Which has the largest atomic radius?", a: "a", options: {a: "Cs", b: "Ag", c: "Pb", d: "Br"}, exp: "Atomic radius increases down a group and decreases across a period. Cs is in the lowest period and farthest left among the choices, giving it the largest radius." },
                { q: "Which has the lowest first-ionization energy?", a: "a", options: {a: "Cs", b: "Ag", c: "Pb", d: "Br"}, exp: "Cs has the lowest ionization energy because it is the largest atom listed. Its valence electron is far from the nucleus and weakly held, requiring the least energy to remove." },
                ...
                { q: "What is the empirical formula of an oxide of chromium that is 48 percent oxygen by mass?", a: "b", options: {a: "Strong initial heating caused some of the hydrate sample to spatter out of the crucible", b: "The dehydrated sample absorbed moisture after heating", c: "The amount of the hydrate sample used was too small", d: "The crucible was not heated to constant mass before use"}, exp: "If the dehydrated sample absorbs moisture from the air after heating, its final mass becomes artificially high. This makes the calculated mass loss (water lost) too small, giving a percent water lower than the true value." },
                ...
                { q: "Which of the following can function as both a Bronsted-Lowry acid and Bronsted-Lowry base?", a: "c", options: {a: "HCl", b: "H_2SO_4", c: "HSO_4-", d: "SO_4 2-"}, exp: "HSO_4^- can donate H+ to form SO_4^2- or accept H+ to form H_2SO_4. This ability to both donate and accept protons makes it amphiprotic." },
            ...
            2: [
                ...
                { q: "Which statement best explains why NaCl dissolves in water?", a: "b", options: {a: "Water breaks covalent bonds", b: "Ion-dipole forces overcome lattice energy", c: "NaCl reacts chemically with water", d: "Water molecules ionize NaCl"}, exp: "Ion–dipole forces between Na+/Cl- and water molecules release enough energy to overcome lattice energy, allowing NaCl to dissolve." },
                { q: "Which compound has the greatest dipole-dipole attractions?", a: "b", options: {a: "CO_2", b: "NH_3", c: "O_2", d: "N_2"}, exp: "NH_3 is polar and has strong dipole–dipole interactions (and hydrogen bonding). CO_2, O_2, and N_2 are nonpolar." },
                ...
                { q: "Which best explains why diamond is extremely hard?", a: "c", options: {a: "Strong intermolecular forces", b: "High polarity", c: "Extended covalent network source", d: "Ionic bonding"}, exp: "Diamond is a covalent network solid where each carbon atom is bonded to four others in a 3‑D lattice. Breaking diamond requires breaking covalent bonds, not intermolecular forces." },
                { q: "Which compound would have the highest boiling point?", a: "d", options: {a: "CH_4", b: "C_2H_6", c: "C_3 H_8", d: "C_4H_10"}, exp: "Boiling point increases with molecular mass and surface area. C_4H_10 has the largest molar mass and strongest London dispersion forces." },
                { q: "Which interaction occurs between water and Na+ ions?", a: "c", options: {a: "Hydrogen Bonding", b: "Dipole-dipole forces", c: "Ion-dipole forces", d: "London dispersion forces"}, exp: "The partially negative oxygen in water is attracted to Na⁺, forming strong ion–dipole interactions." },
                ...
                { q: "Which substance is most likely to be brittle solid?", a: "b", options: {a: "Copper", b: "NaCl", c: "Paraffin wax", d: "Rubber"}, exp: "Ionic solids like NaCl are brittle because shifting the lattice aligns like charges, causing repulsion and fracture." },
                { q: "Why does MgO have a higher boiling point than NaCl?", a: "c", options: {a: "MgO is heavier", b: "MgO has covalent character", c: "Mg2+ and O2- have higher charges", d: "MgO has hydrogen bonding"}, exp: "Mg^2+ and O^2- have higher charges than Na+ and Cl-, giving MgO a much larger lattice energy and higher boiling point." },
            ...
            3: [
                ...
                { q: "Which of the following pure substances has the highest boiling point?", a: "b", options: {a: "CH_4", b: "NH_3", c: "CO_2", d: "C_2H_6"}, exp: "NH_3 forms hydrogen bonds with itself,wgiving it a higher boiling point than other options, which only have dispersion forces." },
            ...
            4: [
                ...
                { q: "Which pair of aqueous solutions will form a precipitate when mixed?", a: "b", options: {a: "NaNO_3(aq)+KCl(aq)", b: "AgNO_3(aq)+NaCl(aq)", c: "NH_4Cl(aq) + Na_2S(aq)", d: "K_2SO_4(aq)+NaNO_3(aq)"}, exp: "AgCl is insoluble. When Ag⁺ and Cl⁻ meet, AgCl(s) forms. Sodium and nitrate ions remain soluble spectator ions." },
                { q: "Which net ionic equation correctly represents the reaction of AgNO_3(aq) and NaBr(aq)?", a: "c", options: {a: "AgNO_3+NaBr->AgBr+NaNO_3", b: "Ag+ +NO_3- + Na+ + Br- ->AgBr+Na+ +NO_3-", c: "Ag+(aq)+Br-(aq)->AgBr(s)", d: "Na+ +NO_3- ->NaNO_3"}, exp: "Sodium bromide is insoluble and precipitates. Sodium and nitrate ions are spectators and must be canceled. Choice C shows only the species that undergo chemical change." },
                { q: "Which reaction forms a precipitate due to a carbonate exception?", a: "b", options: {a: "Na_2CO_3 + KCl", b: "Na_2CO_3 + CaCl_2", c: "Na_2CO_3 + NaNO_3", d: "K_2CO_3 + NaCl"}, exp: "Carbonates are insoluble except with Group 1 or NH_4+. CaCO_3 is insoluble, so Na_2CO_3 + CaCl_2 forms a precipitate." },
            ...
            5: [
                { q: "Which statement best describes a reversible reaction at equilibrium?", a: "c", options: {a: "The reaction has stopped completely", b: "The concentrations has stopped completely", c: "The forward and reverse reactions occur at the same rate", d: "All reactants have been converted into products"}, exp: "At equilibrium, a reversible reaction does not stop. Instead, the forward reaction (reactant forming products) and the reverse reaction(products reforming reactants) continue simultaneously at equal rates. This valence causes concentrations to remain constant over time, but not necessarily equal. This misconception that reactions 'stop' at equilibrium is common but incorrect." },
                { q: "In a system at dynamic equilibrium, which of the following is true?", a: "c", options: {a: "No molecular motion occurs", b: "Forward and reverse reaction rates are zero", c: "Molecular collisions continue to occur", d: "Products are no longer reacting"}, exp: "Dynamic equilibrium means that reactions are still occurring at the molecular level. Particles continue to collide, break bonds and form new ones. The key features is that these processes happen at equal rates in both directions.Therefore, although macroscopic properties remain constant, microscopic activity never stop." },
                { q: "Which reaction is most clearly an example of a reversible chemical equilibrium?", a: "c", options: {a: "Combustion of gasoline", b: "Rusting of iron", c: "Formation of ammonia in the Haber process", d: "Burning magnesium ribbon"}, exp: "The Haber process involves nitrogen and hydrogen reacting to form ammonia, and ammonia decomposing back into nitrogen and hydrogen. Both forward and reverse reactions occur under controlled conditions. Combustion and rusting proceed essentially to completion and are not reversible under normal conditions." },
                { q: "What does the equilibrium constant (K) primarily indicate about a reaction?", a: "c", options: {a: "The speed of the reaction", b: "The time required to reach equilibrium", c: "The relative amounts of products and reactants at equilibrium", d: "The activation energy of the reaction"}, exp: "The equilibrium constant provides information about the relative concentrations of products and reactants at equilibrium, not how fast equilibrium is reached. Reaction speed is determined by kinetics, while K reflects thermodynamic favorability. A large K indicates product-favored equilibrium, while a small K indicates reactant-favored equilibrium." },
                { q: "Which statement about the equilibrium constant K is always true?", a: "c", options: {a: "It changes as concentrations change", b: "It is equal to the reaction rate", c: "It depends on the temperature", d: "It must be greater than 1"}, exp: "The value of K depends only on temperature for a given reaction. Changes in concentration, pressure, or volume may shift equilibrium position but do not change K." },
                { q: "For the reaction 2NO_2(g)<->N_2O_4(g) Which is the correct Kc expression?", a: "b", options: {a: "[NO_2]^2/[N_2O_4]", b: "[N_2O_4]/[NO_2]^2", c: "[NO_2]/[N_2O_4]", d: "[N_2O_4]^2/[NO_2]^2"}, exp: "In a Kc expression, product concentrations are placed in the numerator and reactant concentrations in the denominator. Each concentration is raised to the power of its stoichiometric coefficient. Since one mole of N_2O_4 forms from two moles of NO_2, the correct expression is [N_2O_4]/[NO_2]^2." },
                { q: "What does the equilibrium constant mathematically represent?", a: "b", options: {a: "The ratio of reaction rates", b: "The ratio of product and reactant concentrations at equilibrium", c: "The amount of reactant consumed", d: "The speed of equilibrium establishment"}, exp: "The equilibrium constant is defined as a ratio of product concentrations to reactant concentrations, each raised to their stoichiometric coefficients, evaluated at equilibrium. It does not describe how fast equilibrium is reached, nor how much reactant was initially present. Instead, it reflects the relative stability of products compared to reactants under given temperature conditions." },
                { q: "Why are ICE tables useful when working with equilibrium constants?", a: "b", options: {a: "They calculate reaction rates", b: "They track concentration changes from initial to equilibrium", c: "They determine activation energy", d: "They predict temperature effects"}, exp: "ICE tables organize information about Initial, Change, and equilibrium concentration. They help the student system move toward equilibrium. While K gives a ratio at equilibrium, ICE tables connect that ratio to actual concentration changes, making them essential for conceptual and quantitative equilibrium reasoning." },
                { q: "What is the primary purpose of an ICE table when calculating equilibrium concentrations?", a: "b", options: {a: "To determine reaction rate", b: "To organize concentration changes logically", c: "To eliminate algebra", d: "To calculate temperature effects"}, exp: "ICE tables help organize Initial, Change, and Equilibrium concentrations so that stoichiometry and equilibrium expressions are applied consistently. They do not replace algebra, but they prevent conceptual errors by forcing students to think about reaction direction, magnitude of change, and stoichiometric relationships before plugging values into equations." },
                { q: "A reaction has only reactants present initially. What can be concluded before calculation?", a: "d", options: {a: "The reaction is already at equilibrium", b: "Q>K", c: "Q=K", d: "Q<K"}, exp: "If no products are present initially, the reaction quotient Q equals zero. Since equilibrium constants are always positive, Q>K, meaning the reaction must proceed forward to form products. Recognizing this saves time and ensures the correct sign is chosen in the ICE table." },
                { q: "What does Le Chatelier's principle state?", a: "c", options: {a: "Systems always favors products", b: "Reactions proceed to completion", c: "A system at equilibrium responds to stress by counteracting it", d: "Equilibrium constants change to reduce stress"}, exp: "Le Chatelier's principle describes how a system at equilibrium responds when disturbed. The system shifts in the direction that reduces the applied stress,such as changes in concentration, pressure, or temperature. Importantly, the equilibrium constant does not change unless temperature changes-only the equilibrium position shifts." },
                { q: "What is the correct order of steps when solving equilibrium concentration problems?", a: "b", options: {a: "Write ICE->calculate x->compare Q and K", b: "Compare Q and K->write ICE->solve->validate", c: "Solve for x->Write ICE->validate", d: "Write K->calculate equilibrium->Check Q"}, exp: "The correct logical sequence is to compare Q and K first to determine the direction of shift, then set up the ICE table, solve for equilibrium) concentrations, and finally validate assumptions. Skipping steps often leads to incorrect signs for x or unphysical results like negative concentrations." },
                { q: "What is the reaction quotient (Q)?", a: "c", options: {a: "The equilibrium constant at equilibrium", b: "A ratio using equilibrium concentrations only", c: "A ratio using current concentrations at any time", d: "A measure of reaction speed"}, exp: "The reaction quotient Q, is calculated using the same form as the equilibrium constant, but with current (not necessarily equilibrium concentrations or partial pressures. It can be evaluated at any moment to determine whether a system is at equilibrium and , if not, which direction it will shift to reach equilibrium. Q does to describe the reaction rate." },
                { q: "How does the expression for Q compare to the expression for K?", a: "c", options: {a: "Q includes solids while K does not", b: "Q uses different exponents", c: "Q uses the same mathematical format as K", d: "Q is written only for gases"}, exp: "Q and K are written using the same mathematical expression, with products over reactants raised to their stoichiometric coefficients. The difference lies in the values substituted: Q uses current conditions, while K uses equilibrium conditions. This similarity allows direct comparison between Q and K." },
                { q: "Q=K, what can be concluded?", a: "b", options: {a: "The reaction has stopped", b: "The reaction is at equilibrium", c: "The reaction is irreversible", d: "Concentrations are equal"}, exp: "When Q equals K, the system is at equilibrium. Forward and reverse reaction rates are equal, so concentrations remain constant over time. The reaction has not stopped - dynamic equilibrium still exists at the particulate level." },
                { q: "Which statement correctly describes Q immediately after a reactant is added to a system at equilibrium?", a: "b", options: {a: "Q remains equal to K", b: "Q decreases or increases depending on the reactant added", c: "Q changes only after the system shifts", d: "Q becomes 0"}, exp: "Adding a reactant instantly changes the denominator of the Q expression, so Q changes immediately, before any shift occurs. The system then responds by shifting until Q equals K again. A common trap is thinking the shift happens first - Q always changes first, then the system reacts." },
                { q: "A system at equilibrium has additional reactants added. What is the immediate effect?", a: "b", options: {a: "The equilibrium constant increases", b: "The system shifts to consume the added reactant", c: "The reaction stops temporarily", d: "The temperature increases"}, exp: "Adding reactant increases its concentration, making Q < K. The system responds by shifting in the forward direction to reduce the added stress. Importantly, the equilibrium constant does not change-only the equilibrium position changes." },
                { q: "For a gas-phase equilibrium, increasing pressure favors which side?", a: "b", options: {a: "The side with more gas moles", b: "The side with fewer gas moles", c: "The side with higher molar mass", d: "The side with solids"}, exp: "Increasing pressure compresses the system. The equilibrium shifts toward the side with fewer moles of gas, because that side occupies less volume and reduces pressure. Solids and liquids do not affect this reasoning." },
                { q: "For an endothermic reaction, increasing temperature causes the system to:", a: "b", options: {a: "Shifts toward reactants", b: "Shift towards products", c: "Remain unchanged", d: "Increase pressure"}, exp: "In an endothermic reaction, heat acts like a reactant. Adding heat (increasing temperature) shifts equilibrium toward products to consume the added heat." },
                { q: "What is the single most important rule for Le Chatelier questions?", a: "b", options: {a: "Always count coefficients", b: "Only temperature changes K", c: "Presure always causes shifts", d: "Catalysts favor products"}, exp: "Remembering that only temperature changes the equilibrium constant prevents the most common AP chemistry errors and traps." },
                { q: "A system at equilibrium has its reactant concentration doubled. What happens next?", a: "c", options: {a: "The equilibrium constant doubles", b: "The system shifts to consume reactant", c: "The reaction stops", d: "The system becomes irreversible"}, exp: "Doubling reactant concentration increases Q, making the system no longer at equilibrium. The system responds by shifting in the direction that consumes the added reactant, restoring Q to K. The equilibrium constant itself remains unchanged because temperature did not change." },
                { q: "What does an energy diagram for a reversible reaction primarily illustrate?", a: "b", options: {a: "Reaction speed", b: "Amount of catalyst used", c: "Relative energies of reactants, products, and transition states", d: "Value of the equilibrium constant"}, exp: "Energy diagrams show the relative potential energies of reactants, products, and the transition state for both forward and reverse reactions. They help visualize energy changes but do not directly show rates or equilibrium constants." },
                { q: "If products are lower in energy than reactants, which statement is correct?", a: "b", options: {a: "ΔG>0 and K<1", b: "ΔG<0 and K>1", c: "ΔG=0 and K=1", d: "Reaction is irreversible"}, exp: "Lower-energy products indicate a thermodynamically favorable reaction. This corresponds to a negative ΔH, meaning the reaction favors products at equilibrium and K is greater than 1." },
                { q: "If ΔG=0, what can be concluded about equilibrium?", a: "d", options: {a: "Reaction does not occur", b: "Reactants are favored", c: "Products are formed", d: "Neither sides is favored"}, exp: "When ΔG equals zero, the system is at equilibrium under standard conditions. Reactants and products are equally favored, and K equals 1." },
                { q: "What distinguishes Kp from Kc?", a: "c", options: {a: "Kp uses molarity;Kc uses pressure", b: "Kp uses partial pressures;Kc uses concentrations", c: "Kp applies only to liquid", d: "Kp changes with catalysts"}, exp: "Kp is written using partial pressures of gaseous species, while Kc uses molar concentrations. Both describe the same equilibrium position at a given temperature, but they use different measures of amount. Catalysts do not change either constant." },
                { q: "A concentration vs. time graph shows reactant concentration decreasing and then becoming constant. What does the flat region indicate?", a: "c", options: {a: "Reaction has stopped", b: "Reactants are exhausted", c: "Equilibrium has been reached", d: "Reaction is irreversible"}, exp: "A flat (constant) concentration indicates that the rates of the forward and reverse reactions are equal. The reaction has not stopped-particles continue reacting-but concentrations no longer change." },
                { q: "A sudden increase in product concentration appears as a vertical jump on a graph. What likely occured?", a: "a", options: {a: "Temperature change", b: "Catalysts added", c: "Product added", d: "Pressure decreased"}, exp: "A vertical jump indicates an instantaneous change in concentration, which occurs when a substance is added or removed. Shifts caused by temperature or pressure changes occur gradually, not instantaneously." },
                { q: "Which factor directly increases the rate of a chemical reaction?", a: "c", options: {a: "Increasing temperature", b: "Decreasing surface area", c: "Diluting the reactants", d: "Removing a catalyst"}, exp: "Raising a temperature increases the kinetic energy of molecules, leading to more frequent and energetic conditions, thereby increasing the rate." },
                { q: "Why does increasing the concentration of a reactant typically increase the reaction rate?", a: "a", options: {a: "It increases the molar mass", b: "It lowers activation energy", c: "It leads to more collisions per unit time", d: "It changes the enthalpy of reaction"}, exp: "A higher concentration means more particles per volume, leading to more frequent collisions, which increases the likelihood of successful reactions." },
                { q: "A reaction is first order in A. If [A]=0.40M and the rate constant k=0.20 s^-1, what is the rate?", a: "a", options: {a: "0.08 M/s", b: "0.50 M/s", c: "0.20 M/s", d: "0.80 M/s"}, exp: "For a first-order reaction: Rate=k[A]=(0.20 s^-1)(0.40M)=0.08 M/s" },
                { q: "Which best defines the activation energy of a reaction?", a: "c", options: {a: "The energy released during product formation", b: "The difference in energy between reactants and products", c: "The energy required to break ionic bonds", d: "The minimum energy needed for an effective collsion"}, exp: "Activation energy is the minimum energy that reactant molecules must have during a collision to result in a reaction." },
                { q: "Given the rate law Rate=k[A][B]^2, what is the order of the reaction?", a: "c", options: {a: "First-order", b: "Second-order", c: "Third-order", d: "Zero-order"}, exp: "Total reaction order is the sum of exponents: 1 (from A) + 2 (from B)=3, so the reaction is third-order overall." },
                { q: "C_12H_22O_11(aq) + H_2O(l)->2C_6H_12O_6(aq) The chemical equation shown above represents the hydrolysis of sucrose. Under certain conditions, the rate is directly proportional to the concentration of sucrose. Which statement supports how a change in conditions can increase the rate of this reaction?", a: "c", options: {a: "Increasing the amount of water in which the sugar is dissolved will increase the frequency of collisions between the sucrose molecules and the water molecules resulting in an increase in the rate of hydrolysis.", b: "Decreasing the temperature will increase the frequency of the collisions between the sucrose molecules and the water molecules resulting in an increase in the rate of hydrolysis.", c: "Increasing the concentration of sucrose will increase the rate of hydrolysis by increasing the frequency of the collisions between the sucrose and the water molecules.", d: "Decreasing the concentration of sucrose will increase the rate of hydrolysis by increasing the frequency of the collisions between the sucrose and the water molecules."}, exp: "The rate changes proportionally to the change in the concentration of sucrose and the increase in the rate of hydrolysis can be explained by an increase in the frequency of the collisions between the reactant molecules." },
                { q: "CH_3I+NaOH ->CH_3OH+NaI. The rate of the expression represented by the chemical equation shown above is expressed as rate = k[CH_3I][NaOH]. Based on this information, which of the following claims is correct?", a: "c", options: {a: "The reaction will proceed at a slower rate with increasing temperature", b: "The rate of the reaction will double when the concentrations of both CH_3I and NaOH are doubled", c: "The rate of the reaction will double if the concentration of CH_3I is doubled while keeping the concentration of NaOH constant", d: "A larger amount of CH_3OH will be produced if the concentrations of CH_3I and NaOH are halved"}, exp: "Based on the information given, doubling the concentrations of CH_3I while keeping the concentration of NaOH constant will double the rate of the reaction. Based on collision theory, the rate is faster as a result of the increased frequency of collisions when the concentration is increased." }
            ],
            6: [
                { q: "Which statement best describes the relationship between heat (q) and temperature (T)?", a: "b", options: {a: "Heat and temperature are the same physical quantity", b: "Heat measures total energy, while temperature measures average kinetic energy", c: "Temperature determines the direction of heat flow but not its magnitude", d: "Heat is an intensive property, while temperature is extensive"}, exp: "Temperature reflects the average kinetic energy of particles in a substance, not the total energy present. Heat on the other hand, is energy transferred between objects due to a temperature difference. A small object at high temperature can have less total energy than a large object at lower temperature. This distinction is critical in thermodynamics and explains why heat depends on both mass and temperature change" },
                { q: "A system absorbs 250J of heat and does 100 J of work on the surroundings. What is the change in internal energy?", a: "c", options: {a: "-350J", b: "-150 J", c: "+150J", d: "+350J"}, exp: "The first law of thermodynamics states ΔE = q-w (where work done by the system is positive). The system absorbs 250 J of heat (q=+250J) and does 100 J of work (w=+100 J). Substituting values given ΔE= 250 -100=+150J. A positive ΔH indicates an increase in the system's internal energy" },
                { q: "Which statement best explains why water has a high specific heat capacity?", a: "b", options: {a: "Water molecules are small", b: "Water has strong hydrogen bonding", c: "Water is electrically neutral", d: "Water has low molar mass"}, exp: "Hydrogen bonding between water molecules requires significant energy to disrupt. When heat is added, much of the energy goes into breaking these intermolecular attractions rather than increasing kinetic energy. This results in a slower temperature and a high specific heat capacity, making water effective at stabilizing temperatures in natural systems" },
                { q: "Which statement best explains why breaking chemical bonds requires energy input?", a: "b", options: {a: "Bond breaking releases stored potential energy", b: "Energy is needed to overcome electrostatic attractions", c: "Bond breaking increases entropy", d: "Heat is released when atoms seperate"}, exp: "Chemical bonds form due to attractive forces between nuclei and electrons. Breaking a bond requires energy to overcome these electrostatic attractions. This energy input increases the system's potential energy. Bond formation, in contrast, releases energy, understanding this distinction is essential when analyzing energy diagrams and reaction enthalpy." },
                { q: "Which observation best indicates that a reaction is exothermic without using temperature data?", a: "b", options: {a: "Products form faster than reactants", b: "Surroundings feel warmer after the reaction", c: "Reaction reaches equilibrium quickly", d: "Gas volumes decreases"}, exp: "An exothermic reaction releases energy to its surroundings. Even without measuring temperature numerically, a noticeable warming of the surroundings indicates heat is leaving the system. Reaction speed, equilibrium position, or gas volume changes do not alone confirm whether heat is released or consumed." },
                { q: "A heating curve shows a flat region while energy continues to be added. What does this indicate?", a: "c", options: {a: "Kinetic energy is increasing", b: "Temperature measurement is faulty", c: "Potential energy is increasing", d: "Heat transfer has stopped"}, exp: "Flat regions on heating curves represent phase changes. During these intervals energy is used to overcome intermolecular forces, increasing potential energy rather than kinetic energy. As a result, temperature remains constant even though heat continues to enter the system." },
                { q: "Which condition must be true for ΔH = q?", a: "b", options: {a: "Volume is constant", b: "Pressure is constant", c: "No heat transfer occurs", d: "No work is done"}, exp: "ΔH equals heat flow only when pressure remains constant, which is the case for most reactions open to the atmosphere. Constant-volume conditions relate heat flow to ΔE instead, which is why different calorimeters measure different energy quantities." },
                { q: "Which process is always endothermic?", a: "c", options: {a: "Condensation of water vapor", b: "Freezing of liquid ethanol", c: "Vaporization of a liquid", d: "Formation of ionic solids"}, exp: "Vaporization requires energy to overcome intermolecular forces holding particles together in the liquid phase. This energy is absorbed from the surroundings, making vaporization an endothermic process. Condensation and freezing release energy, while formation of ionic solids typically releases lattice energy, making those processes exothermic." },
                { q: "A metal sample absorbs 4.20kJ of heat and its temperature increases by 20.0°C. Which conclusion is valid without knowing the metal's identity?", a: "b", options: {a: "The metal has high density", b: "The metal has low specific heat", c: "The metal's mass is small", d: "The metal's expanded"}, exp: "A relatively small temperature increase with a  modest heat input suggests the substance does not require much energy to raise its temperature. Without knowing mass, we cannot calculate specific heat numerically, but metals generally exhibit lower specific heat than substances like water. Density and expansion cannot be inferred from this data alone." },
                { q: "Why does increasing external pressure reduce work done by a gas during expansion?", a: "b", options: {a: "Gas particles slow down", b: "Volume change becomes smaller", c: "Energy is converted to heat", d: "Internal energy increases"}, exp: "Work depends on pressure and volume change (w=-P(change in volume)). Higher external pressure resists expansion, reducing the amount of volume change that occurs. As a result, the gas does less work on the surroundings under higher opposing pressure." },
                { q: "Which condition must be true for ΔH = q?", a: "b", options: {a: "Volume is constant", b: "Pressure is constant", c: "No heat transfer occurs", d: "No work is done"}, exp: "ΔH equals heat flow only when pressure remains constant, which is the case for most reactions open to the atmosphere. Constant-volume conditions relate heat flow to change in E instead, which is why different calorimeters measure different energy quantities." },
                { q: "Which experimental mistake cause an exothermic reaction to appear endothermic?", a: "c", options: {a: "Overestimating ΔT", b: "Using excess water", c: "Ignoring heat absorbed from surroundings", d: "Large sample size"}, exp: "If heat entering the system from the surroundings is not accounted for, the reaction may falsely appear to absorb heat. This reverses the true interpretation of an exothermic reaction." },
                { q: "A gas is compressed rapidly in an insulated container. What happens to q, w, and temperature?", a: "b", options: {a: "q>0, w>0, T increases", b: "q=0, w<0, T increases", c: "q=0, w>0, T decreases", d: "q<0, w<0, T decreases"}, exp: "Insulated means adiabatic, so q = 0. Compression means work is done on the system, so w < 0. This increases internal energy, raising the temperature of the gas." },
                { q: "A coffee-cup calorimeter gives a ΔH value that is too small in magnitude. Which error must likely caused this?", a: "b", options: {a: "Overestimating ΔT", b: "Underestimating ΔT", c: "Using excess water", d: "Large sample size"}, exp: "If the measured temperature change is underestimated, the calculated heat using q=mcΔT will be smaller than the true value. This makes ΔH appear less exothermic or less endothermic than it actually is." },
                { q: "A system absorbs 3.0kJ of heat and expands, doing 1.5 kJ of work. Which statement is correct?", a: "c", options: {a: "ΔE=-4.5 kJ", b: "E=-1.5kJ", c: "ΔE=+1.5kJ", d: "ΔE=+4.5kJ"}, exp: "Heat absorbed gives q = +3.0kJ. expansion means work is done by the system, so w = 1.5 kJ. Applying ΔE=q-w gives ΔE=3.0-1.5=1.5kJ. Although the system loses energy as work, it gains more energy as heat, resulting in a net increase in internal energy." },
                { q: "Which observation confirms that both heat and work occurred during a process?", a: "c", options: {a: "Temperature change only", b: "Volume change only", c: "Temperature change and volume change", d: "Color Change"}, exp: "A temperature change indicates heat transfer, while a volume change against pressure indicates work. Observing both confirms that energy transfer occurred via both mechanisms." },
                { q: "Which situation would cause ΔH to be less negative than its true value for an exothermic reaction?", a: "b", options: {a: "Overestimating ΔT", b: "Underestimating ΔT", c: "Excess insulation", d: "Large sample mass"}, exp: "Underestimating the temperature change reduces calculated heat release, making the reaction appear less exothermic (ΔH is less negative) than it actually is." },
                { q: "Which condition ensures that ΔH and q have the same numerical value?", a: "b", options: {a: "Constant volume", b: "Constant pressure", c: "Adiabatic process", d: "No temperature change"}, exp: "At constant pressure, the heat exchanged by the system equals the enthalpy change. This relationship is why coffee-cup calorimetry measures ΔH directly." },
                { q: "Which statement best explains why two samples at the same temperature can contain different total energies?", a: "b", options: {a: "Temperature depends on mass", b: "Total energy depends on amount and composition", c: "Heat equals temperature", d: "Pressure determines energy"}, exp: "Temperature measures average kinetic energy, not total energy. Total internal energy depends on how many particles are present and how energy is stored through bonding and intermolecular forces." },
                { q: "Which process requires energy input but does not increase average kinetic energy?", a: "b", options: {a: "Heating a gas", b: "Vaporizing a liquid", c: "Compressing a gas", d: "Heating a solid"}, exp: "During vaporization, energy is used to overcome intermolecular forces, increasing potential energy. Particle speed-and therefore average kinetic energy and temperature-remain constant during the phase change." },
                { q: "Which observation alone is sufficient to conclude that ΔH < 0 for a reaction?", a: "c", options: {a: "The reaction occurs rapidly", b: "The system's temperature increases", c: "The surroundings warm noticeably", d: "Gas is produced"}, exp: "A warming of the surroundings indicates heat is released from the system to the surroundings, which defines an exothermic process. This directly implies ΔH < 0, regardless of reaction rate, gas formation, or system temperature behavior." },
                { q: "Which factor most strongly determines the magnitude of work during gas expansion?", a: "b", options: {a: "Temperature change", b: "External pressure", c: "Heat absorbed", d: "Specific heat"}, exp: "Work is calculated as w=PΔV. While temperature and heat can influence expansion, external pressure directly controls how much energy is down for a given volume change." },
                { q: "Which process increases internal energy but decreases entropy?", a: "c", options: {a: "Vaporization", b: "Gas expansion", c: "Freezing under compression", d: "Heating gas"}, exp: "Freezing increases order, lowering entropy. If compression work is done simultaneously, energy enters the system as work, increasing internal energy despite the decrease in entropy." },
                { q: "Which situation ensures that internal energy does not change even though heat and work occur?", a: "a", options: {a: "Isothermal expansion of an ideal gas", b: "Isobaric heating of a liquid", c: "Phase change at constant pressure", d: "Adiabatic compression"}, exp: "For an ideal gas, internal energy depends only on temperature. In an isothermal process temperature remains constant, so internal energy does not change, even though heat and work may be exchanged." },
                { q: "A gas expands isothermally against a constant external pressure. Which statement must be true?", a: "b", options: {a: "q = 0", b: "ΔE = 0", c: "w=0", d: "Temperature decreases"}, exp: "In an isothermal process, temperature remains constant, so average kinetic energy does not change. For an ideal gas, this means ΔE=0. Heat absorbed equals work done by the gas, but neither is zero." },
                { q: "Which situation would cause the largest discrepancy between measured and true ΔH in a coffee cup calorimetry?", a: "c", options: {a: "Using excess solution volume", b: "Small reaction enthalpy", c: "Significant heat exchange with air", d: "Accurate thermometer calibration"}, exp: "Coffee-cup calorimetry assumes no heat exchange with surroundings. Significant heat loss or gain from air violates this assumption, producing the great deviation between measured and true ΔH. Volume and thermometer accuracy matter, but not as dramatically." },
                { q: "A 50.0 g sample of a substance absorbs 1.00 kJ of heat and its temperature rises by 10.0°C. Which conclusion is valid?", a: "b", options: {a: "The substance has a high specific heat", b: "The substance has a low specific heat", c: "The substance is a metal", d: "The substance expanded significantly"}, exp: "Absorbing only 1.00 kJ of heat while experiencing a noticeable temperature increase suggests the substance requires relatively little energy per gram per degree. That indicates a low specific heat. Substance identity and expansion cannot be determined from this information alone." },
                { q: "A calorimeter records a temperature decrease when a salt dissolves. Which conclusion is correct?", a: "c", options: {a: "The dissolution is exothermic", b: "The salt has low solubility", c: "The dissolution is endothermic", d: "The solution did work"}, exp: "A temperature decrease indicates heat is absorbed from the surroundings by the dissolving process. This is characteristic of an endothermic dissolution. Solubility and work cannot be concluded from temperature change alone." },
                { q: "A reaction releases 600 J of heat while 200 J of work is done on the system. What is ΔE(change in energy)?", a: "b", options: {a: "-800 J", b: "-400 J", c: "+400 J", d: "+800 J"}, exp: "Using ΔE=q-w, released what means q=-600 J. Work done on the system means w=-200J. Substituting ΔE = -600-(-200)=-400J. Internal energy decreases overall." },
                { q: "A metal sample absorbs 4.20 kJ of heat and its temperature increases by 20.0°C. Which conclusion is valid without knowing the metal's identity?", a: "b", options: {a: "The metal has high density", b: "The metal has low specific heat", c: "The metal's mass is small", d: "The metal expanded"}, exp: "A relatively small temperature increase with a modest heat input suggests the substance does not require much energy to raise its temperature. Without knowing mass, we cannot calculate specific heat numerically, but metals generally exhibit lower specific heat than substances like water. Density and expansion cannot be inferred from this data alone." },
                { q: "Why does increasing external pressure reduce work done by a gas during expansion?", a: "b", options: {a: "Gas particles slow down", b: "Volume change becomes smaller", c: "Energy is converted to heat", d: "Internal energy increases"}, exp: "Work depends on pressure and volume change (w=PΔV). Higher external pressure resists expansion, reducing the amount of volume change that occurs. As a result, the gas does less work on the surroundings under higher opposing pressure." },
                { q: "What is the standard unit for measuring enthalpy change (ΔH)?", a: "c", options: {a: "Kilojoules per gram", b: "Joules per mole", c: "Kilojoules per mole", d: "Calories per mole"}, exp: "Enthalpy change is typically measured in kilojoules per mole (kJ/mol), representing the energy change per mole of substance." },
                { q: "Which of the following best describes an endothermic process?", a: "b", options: {a: "Heat is released and ΔH is negative", b: "Heat is absorbed and ΔH is positive", c: "Temperature decreases and entropy increases", d: "Heat flows from the system to the surroundings"}, exp: "In endothermic processes, the system absorbs heat from surroundings, resulting in a positive enthalpy change." },
                { q: "A student dissolves NH_4Cl and observes the beaker becoming cold. What can be inferred about the enthalpy change of the process?", a: "d", options: {a: "It is exothermic", b: "ΔH is negative", c: "Heat is absorbed by the surroundings", d: "Heat is absorbed by the system"}, exp: "The system (NH_4Cl + water) absorbs heat from the surroundings, making the beaker feel cold, indicating an endothermic reaction." }
            ],
            7: [
                { q: "Chemical equilibrium is most likely analogous to which physical situation?", a: "c", options: {a: "A ball rolling downhill", b: "A pendulum swinging", c: "A book resting on a table", d: "A car accelerating"}, exp: "A book resting on a table experiences forces that balance so there is no net motion, even though forces still act. Similarly, at chemical equilibrium, forward and reverse reactions continue, but their effects cancel, producing no net change. This analogy emphasizes balanced opposing processes, not absence of activity." },
                { q: "A system at equilibrium is disturbed, and both forward and reverse reaction rates increase, yet equilibrium position does not change. Why does this not violate Le Chatelier's principle?", a: "c", options: {a: "Le Chatelier principle applies only to gases", b: "Le Chatelier predicts rate changes", c: "Rate changes alone do not imply position change", d: "Equilibrium constants are unaffected"}, exp: "Le Chatelier's principle changes in equilibrium position, not reaction rates. Both rates increasing equally (for example, after catalyst addition or temperature increase without favoring one side) does not cause a shift. Confusing rate effects with position effects in the core paradox here." },
                { q: "A reaction has a very small K, yet the product concentration is nonzero at equilibrium. Which statement best explains this?", a: "b", options: {a: "Reaction is incomplete", b: "Equilibrium is dynamic", c: "Products are unstable", d: "K does ot represent equilibrium"}, exp: "Even when K is very small, equilibrium still represents a dynamic balance. Forward and reverse reactions continue, allowing small but nonzero product concentrations. This tests understanding of dynamic equilibrium vs magnitude of K." },
                { q: "A reaction mixture is at equilibrium. A student removes a small amount of product, but the measured equilibrium concentrations after re-equilibration are numerically identical to before. Which conclusion is valid?", a: "c", options: {a: "The reaction is irreversible", b: "The reaction has K>>1", c: "The disturbance was within experimental uncertainty", d: "The system did not respond to the change"}, exp: "Thermodynamically, the system must respond to product removal by shifting forward. However, if the removed amount is very small, the resulting change in equilibrium concentrations may fall below the resolution of measurement. This does not imply irreversibility or lack of response." },
                { q: "A student observes that Q = K at a single instant. What can be concluded with certainty?", a: "c", options: {a: "A system has been at equilibrium for a long time", b: "The system will not shift", c: "The system is at equilibrium at that constant", d: "The reaction has stopped"}, exp: "Q=K defines equilibrium at that moment only. It does not imply the system has been stable for any length of time, nor that reactions have stopped. This question tests time-specific reasoning rather than static thinking." },
                { q: "A system is at equilibrium. Reactants are added, but equilibrium concentrations of both reactants and products increase after re-equilibration. Which conclusion is logically valid?", a: "d", options: {a: "The reaction is endothermic", b: "ΔN > 0", c: "K increased", d: "None of the above"}, exp: "Adding reactant guarantees a disturbance, but observing that both equilibrium concentrations increased does not uniquely determine reaction enthalpy, Δn, or a change in K. Temperature was not stated to change, so K cannot be assumed to increase. Multiple reaction types can show this outcome depending on stoichiometry. This is a classic 'tempting inference' trap." },
                { q: "A reaction has K=1.0*10^-3 at 25°C. Which statement must be true?", a: "b", options: {a: "The reaction is slow", b: "Reactants dominate at equilibrium", c: "Products never form", d: "The reaction is exothermic"}, exp: "A small K indicates reactant-favored equilibrium. K does not provide information about rate, enthalpy, or whether products form at all. Products still exist-just in smaller amounts." },
                { q: "Which conclusion can be drawn if a reaction reaches the same equilibrium composition from three different starting mixtures?", a: "d", options: {a: "Reaction is fast", b: "Reaction is endothermic", c: "Equilibrium is kinetically controlled", d: "Equilibrium position is thermodynamically defined"}, exp: "Reaching the same equilibrium regardless of starting conditions demonstrates that equilibrium is determined by thermodynamics (K), not kinetics. This eliminates ideas about rate or activation energy and focuses on the defining nature of equilibrium." },
                { q: "A system is at equilibrium. A student adds reactant and immediately measures concentrations before any shift occurs. Which statement must be true at that instant?", a: "b", options: {a: "Q = K", b: "Q < K", c: "Q > K", d: "Equilibrium has shifted"}, exp: "Adding reactant increases the denominator of the reaction quotient expression, immediately lowering Q. At that instant, the system has not yet had time to shift, so K is unchanged while Q has decreased. Therefore Q < K." },
                { q: "Two experiments of the same reaction are conducted at the same temperature. Both reach equilibrium, but Experiment 1 has a larger product-to-reactant ratio than Experiment 2. Which conclusion is valid?", a: "d", options: {a: "Experiment 1 has a larger K", b: "Experiment 2 has a larger K", c: "The two experiments must have different K values", d: "Neither experiment changed K"}, exp: "If both experiments are conducted at the same temperature for the same reaction, the equilibrium constant K must be the same. Different equilibrium compositions can result from different initial conditions or disturbances, but K itself is unchanged." },
                { q: "A concentration-time graph shows reactant concentration decreasing smoothly and then becoming constant, while product reactant increases and then becomes constant. What does the flat portion of both curves  indicate?", a: "c", options: {a: "Reaction completion", b: "Equal concentrations", c: "Equilibrium has been reached", d: "Reaction rate is zero"}, exp: "Flat(horizonal) regions on concentration-time graphs indicate that concentrations are no longer changing with time. This occurs when the forward and reverse reaction rates are equal which defines equilibrium." },
                { q: "Which change causes an equilibrium shift only because concentrations change, not because pressure changes?", a: "d", options: {a: "Compressing a gas mixture", b: "Adding inert gas at constant pressure", c: "Adding inert gas at constant volume", d: "Removing a reactant from solution"}, exp: "Removing a reactant directly changes concentration and shifts equilibrium. Adding inert gas at constant volume does not change concentrations or partial pressure, not concentration alone. This question isolates concentration effects from pressure effects." },
                { q: "A reaction mixture is prepared with reactants only and then sealed at constant temperature. Which statement must be true before equilibrium is reached?", a: "c", options: {a: "Product concentration remains zero", b: "Reverse reaction rate is greater than forward rate", c: "Forward reaction rate is greater than reverse rate", d: "Concentrations remain constant"}, exp: "When a system starts with only reactants, no products are present initially, so the reverse reaction cannot occur at first. As soon as products begin forming, the reverse rate increases, but until equilibrium is reached, the forward rate remains greater than the reverse rate." },
                { q: "Which change will increase the value of KKK for an endothermic reaction?", a: "b", options: {a: "Decreasing temperature", b: "Increasing temperature", c: "Adding catalyst", d: "Increasing pressure"}, exp: "Endothermic reactions absorb heat. Increasing temperature favors product formation and shifts equilibrium right, resulting in a larger equilibrium constant. Only temperature affects the numerical value of KKK." },
                { q: "If a reaction mixture has Q=4.5 Q=4.5 Q=4.5 and K=1.2 K=1.2 K=1.2, what will occur?", a: "b", options: {a: "The reaction will shift right", b: "The reaction will shift left", c: "The reaction is at equilibrium", d: "The reaction will stop"}, exp: "Since Q>KQ>KQ>K, the system has too many products relative to reactants. To re-establish equilibrium, the reaction proceeds in the reverse direction, forming more reactants and decreasing product concentration until Q=KQ=KQ=K. The reaction does not stop; it dynamically shifts until equilibrium is restored." },
                { q: "Which change will not shift the equilibrium position of a system?", a: "c", options: {a: "Changing concentration", b: "Changing temperature", c: "Adding a catalyst", d: "Changing pressure (gaseous system)"}, exp: "A catalyst lowers activation energy equally for forward and reverse reactions, allowing equilibrium to be reached faster without changing the equilibrium concentrations. In contrast, changes in concentration, pressure (for gases), or temperature alter system stress and cause equilibrium shifts." },
                { q: "What does it mean for a chemical reaction to be at dynamic equilibrium?", a: "b", options: {a: "The reaction has stopped completely", b: "The forward and reverse reactions occur at the same rate", c: "The concentrations of reactants and products are equal", d: "Only products are present"}, exp: "At dynamic equilibrium, the forward and reverse reactions continue to occur at equal rates, so the overall concentrations remain constant over time." },
                { q: "Which observation indicates that a chemical system has reached equilibrium?", a: "c", options: {a: "Concentrations of all species becomes zero", b: "Gas bubbles are no longer produced", c: "The concentrations of all species remain constant over time", d: "The reaction mixture becomes colorless"}, exp: "Constant concentrations over time indicate equilibrium has been reached, even if the reactions are still occuring." },
                { q: "For the reaction: N_2(g)+3H_2(g)<-->2NH_3(g)+heat  Which change will shift the equilibrium to the right?", a: "b", options: {a: "Increasing temperature", b: "Removing NH_3", c: "Decreasing pressure", d: "Adding a catalyst"}, exp: "Removing NH_3 reduces product concentration. THe system shifts right to produce more NH_3 and restore balance." },
                { q: "In the exothermic reaction: 2NO(g)+O_2(g)<-->2NO-2(g), which happens if temperature is increased?", a: "c", options: {a: "Equilibrium shifts right", b: "No change occurs", c: "Equilibrium shifts left", d: "The reaction stops"}, exp: "Adding heat to an exothermic reaction favors the reverse (endothermic) direction, shifting equilibrium toward the reactants." },
                { q: "A student says that increasing pressure always favors the product side. Is this true?", a: "c", options: {a: "Yes, pressure increases always favor products", b: "No, pressure only affects solids", c: "No, it depends on the number of moles of gas", d: "Yes, if the reaction is exothermic"}, exp: "Pressure affects only gas-phase equilibria and shifts toward the side with fewer moles of gas." },
                { q: "N_2(g)+3H_2(g)<-->2NH_3(g), Give the reaction above, what is the equilibrium constant, Kc?", a: "c", options: {a: "Kc=[N_2][H_2]^3/[2NH_3]^2", b: "Kc=[NH_3]/[H_2][N_2]", c: "Kc=[NH_3]^2/[H_2]^3[N_2]", d: "Kc=[N_2][H_2]/[NH_3]"}, exp: "This reaction shows the formation of ammonia. A general reaction would be aA+bB<-->cC+dD. Since all the reactants and products are gas particles, they will be included in the equilibrium expression which is expressed by Kc=(C)^c(D)^d/(A)^a(B)^b." },
                { q: "At a constant temperature, which of the following reactions would be affected from a change in pressure?", a: "a", options: {a: "2SO_2(g)+O_2(g)<-->2SO_3(g)", b: "N_2(g)+H_2(g)<-->2NH_3(g)", c: "2HI(g)<-->H-2(g)+I_2(g)", d: "2NO(g)<-->N_2(g)+O_2(g)"}, exp: "The equilibrium can be affected by the total number of gas moles. In the provided reactions, choice a is the only answer with a different number of gas moles in reactant and product." },
                { q: "At a constant temperature, an increase in pressure would lead to an increase in product for which of the following reactions?", a: "c", options: {a: "2NO(g)<-->N_2(g)+O_2(g)", b: "H_2(g)+CO_2(g)<-->H_2O(g)+CO(g)", c: "CO(g)+Cl_2(g)<-->COCl_2(g)", d: "2N_2O_5<-->4NO_2(g)+O_2(g)"}, exp: "The equilibrium can be affected by the total number of gas moles. An increase in pressure would favor the side of the reaction with less gas moles to establish equilibrium. The choice c consists of 2 moles of gas in the reactant side and 1 mole of gas in the product side which lead to an increase in product." },
                { q: "CaCO_3(g)+energy<-->CaO(s)+CO_2(g), The given reaction above takes place in a container. Given the reaction, which of the following changes would lead to an increase in the concentration of CO_2(g)?", a: "a", options: {a: "An increase in temperature", b: "A decrease in temperature", c: "An increase in container", d: "A decrease in container"}, exp: "The given reaction is an endothermic process as the energy is on the product side. Due to that reason, an increase in temperature would lead to the reaction to favor the product side in order to achieve equilibrium." },
                { q: "H_2(g)+I_2(g)<-->2HI ΔH=58 kJ/mol, The reaction provided is in an equilibrium at 25°C. What is the expression of the equilibrium constant for the reaction?", a: "a", options: {a: "Kc=[H_2][I_2]/[HI]^2", b: "Kc=[HI]^2/[H_2][I_2]", c: "Kc=[HI]/[H_2][I_2]", d: "Kc=[H_2][I_2]/[HI]"}, exp: "A general reaction would be aA+bB<-->cC+dD. Since all the reactants and products are gas particles, they will be included in the equilibrium expression which is expressed by Kc=(C)^c(D)^d/(A)^a(B)^b." },
                { q: "Which of the following changes would affect the reverse reaction to speed up?", a: "b", options: {a: "Increase the temperature", b: "Decrease the temperature", c: "Increase the concentration of I_2", d: "Decrease the pressure"}, exp: "The ΔH is positive, therefore the reaction is an endothermic process. Decreasing the temperature would lead to the reverse reaction to speed up in order to achieve equilibrium." },
                { q: "Which of the following would lead to a reduction in the value of the equilibrium constant?", a: "a", options: {a: "Decrease the temperature", b: "Increase the temperature", c: "Increase the concentration of I_2", d: "Decrease the pressure"}, exp: "Lower T => shifts left => K decreases." },
                { q: "The value of the Kc is 5.0. Which of the following would result in order to reach equilibrium if the initial concentration of all three species is 3.0?", a: "b", options: {a: "No change would occur", b: "The rate of forward reaction will increase", c: "The rate of reverse reaction will increase", d: "Both sides of the reaction will increase"}, exp: "The value of Q will determine the side that the reaction will shift towards. The value of Q can be determined by substituting the concentration in the expression Q=(H_2)(I_2)/(HI)^2. This would result in Q = (3.0)(3.0)/(3.0)^2 which would equal to 1. Since the value of Q is less than K, the reaction would shift to the right in order to reach equilibrium which would result in the rate of forward reaction to increase." },
                { q: "2NO(g)<-->N_2(g)+O_2(g) From the reaction given above, what is the expression of the equilibrium constant, Kp?", a: "a", options: {a: "Kp=(O_2)(N_2)/(NO)^2", b: "Kp=(O^2)(N^2)/(NO)", c: "Kp=(NO)^2/(O_2)(N_2)", d: "Kp=(NO)/(O_2)(N_2)"}, exp: "A general reaction would be aA+bB<-->cC+dD. SInce all the reactants and products are gas particles, they will be included in the equilibrium expression which is expressed by Kp=(C)^c(D)^d/(A)^a(B)^b." },
                { q: "The reaction provided above has reached equilibrium at a certain temperature. During that time, the partial pressure due to No has 3 atmospheres, the partial pressure due to N_2 has 2 atmospheres, and the partial pressure due to O_2 was 3 atmospheres. What is the value of the equilibrium constant, Kp?", a: "b", options: {a: "1/3", b: "2/3", c: "1", d: "2"}, exp: "The expression of Kp is (O_2)(N_2)/(NO)^2. From substituting the atmospheres in the expression, Kp=(2)(3)/(3)^2. This would result in Kp=2/3." },
                { q: "The Ksp value of AgBr is 7.7*10^-13. Which of the following is equal to the solubility of AgBr?", a: "c", options: {a: "7.7*10^-13 molar", b: "5.9*10^-25 molar", c: "8.8*10^-7 molar", d: "3.8*10^-13 molar"}, exp: "The maximum concentration of the solution determines the solubility. In order to find the solubility of AgBr, we can find the concentration of Ag+ or Br- as the mole ratio is 1 to 1. The Ksp value will be the square root of 7.7*10^-13." },
                { q: "Pb 2+(aq)+ Zn (s) <--> Pb(s) + Zn 2+(aq) Keq=3*10^30. A student performed an experiment where he put a 0.20 mol sample of solid zinc into a 500mL solution of 1.0M PbSO_3(aq). After a long period of time, what would be a possible result?", a: "d", options: {a: "Most of the Zn(s) remains", b: "Half of the Zn(s) remains", c: "All of the Pb²⁺ remains unreacted", d: "All of the Pb²⁺ is essentially consumed"}, exp: "The large value of Keq indicates that the reaction almost goes into a completion during equilibrium which results in almost all the concentration of Zn solid to disappear." },
                { q: "The solubility of AgI is 8.0*10^-17. What is the solubility product constant Ksp, for AgI?", a: "d", options: {a: "1.6*10^-16", b: "8.9*10^-9", c: "8*10^-17", d: "6.4*10^-33"}, exp: "Since the maximum concentration determines the solubility of the substance, we can find the solubility product constant by substituting 8*10-17 molar in Ksp=[Ag+][I-]. The mole ratio of Ag to I is 1 to 1, which means [A+]=[I-]. Therefore,Ksp=[8*10-17][8*10-17]=6.4*10-33." }
            ],
            8: [
                { q: "In a weak acid-strong base titration, which process controls pH well before half-equivalence?", a: "c", options: {a: "Conjugate base hydrolysis", b: "Excess OH-", c: "Weak acid equilibrium", d: "Buffer equilibrium"}, exp: "Early in the titration, only a small fraction of the weak acid has been neutralized. The solution still behaves primarily as a weak acid in water, so pH is governed by the acid's Ka equilibrium rather than buffering or excess base effects." },
                { q: "Which buffer composition best resists a large addition of strong acid?", a: "c", options: {a: "High concentration, equal HA and A-", b: "Dilute solution with excess A-", c: "Concentrated solution with excess A-", d: "Concentrated solution with excess HA"}, exp: "Buffer resistance depends on both capacity (total moles of buffering species) and directional composition. To neutralize added acid, conjugate base must be present, and higher total concentration increases capacity. A concentrated buffer with excess A= provides the greatest resistance to a large acid addition." },
                { q: "Which buffer composition would best resist a sudden addition of base?", a: "a", options: {a: "Excess conjugate acid", b: "Excess conjugate base", c: "Equal amounts of acid and base", d: "Very dilute buffer"}, exp: "To resist adding OH-, a buffer must contain sufficient weak acid to neutralize the base. A buffer rich in conjugate acid can absorb more OH- before the pH rises significantly. Equal amounts offer balanced buffering, but directional resistance depends on the species available to counter the disturbance." },
                { q: "Which observation most strongly supports that stoichiometry, not equilibrium, controls the pH of a solution?", a: "c", options: {a: "pH remains near pKa", b: "Gradual pH change upon addition", c: "Sudden pH change after mixing", d: "Equal amounts of HA and A"}, exp: "A sudden pH change indicates that a limiting reactant has been completely consumed, characteristic of stoichiometric control. Equilibrium control results in gradual pH changes as reversible reactions re-establish balance. Identifying which regime applies is critical before choosing a calculation method." },
                { q: "A buffer is prepared using a weak acid HA (pKa=4.9). Which pH range will provide the most effective buffering?", a: "b", options: {a: "2.0-3.0", b: "3.8-5.8", c: "6.8-8.8", d: "9.8-11.8"}, exp: "Buffers are most effective within approximately 1 pH unit of the acid's pKa. In this range, both HA and A- are present in comparable amounts, allowing the buffer to neutralize added acid or base efficiently. Outside this range, one component becomes depleted, sharply reducing buffering capacity." },
                { q: "Which addition will cause the smallest immediate change in pH for an acetate/acetic acid buffer?", a: "c", options: {a: "A small amount of HCl", b: "A small amount of NaOH", c: "A small amount of NaCl", d: "A large amount of NaOH"}, exp: "NaCl dissociates into spectator ions that do not participate in acid-base equilibria. As a result, it does not alter the ratio of acetate to acetic acid, leaving pH unchanged. Small additions of strong acid or base are partially neutralized but still cause some pH change, while a large addition overwhelms buffering capacity." },
                { q: "Which mixture forms a buffer after reaction is complete?", a: "b", options: {a: "Excess HCl+NaOH", b: "Equal amount of NH_3+HCl", c: "Equal NaOH + HNO_3", d: "Excess NaOH+CH_3COOH"}, exp: "Equal moles of NH_3 and HCl produce NH_4+ while leaving NH_3 present, forming a conjugate pair. Buffers often arise from partial neutralization." },
                { q: "Which statement best explains why a very dilute strong acid does not have extremely low pH?", a: "b", options: {a: "Ka decreases at low concentration", b: "Water autoionization contributes significantly", c: "Strong acids partially ionize", d: "OH- concentration increases"}, exp: "At very low acid concentrations, the hydrogen ions produced by water autoionization become comparable to those from the acid itself. The pH therefore reflects contributions from both sources." },
                { q: "Two weak acids have identical concentrations. Acid X has a Ka ten times larger than acid Y. Which comparison is correct?", a: "c", options: {a: "X has higher pH", b: "Y has higher percent ionization", c: "X produces more H+ at equilibrium", d: "Both have equal pH"}, exp: "A large Ka indicates a greater tendency to ionize, producing more hydrogen ions at equilibrium. Even though both acids are weak, Acid X ionizes to a greater extent, resulting in a lower pH. Percent ionization and equilibrium position are directly tied to Ka when concentrations is held constant." },
                { q: "A weak monoprotic acid HA is titrated with NaOH. At a certain point, the solution contains 0.020 mol HA and 0.080 mol A-.Which statement must be true?", a: "c", options: {a: "pH < pKa", b: "pH = pKa", c: "pH > pKa", d: "pH = 7"}, exp: "Using the Henderson-Hasselbalch equation, pH depends on the ratio of conjugate base to acid. Since [A-]>[HA][A^-]>[HA][A-]>[HA], the logarithmic term is positive, making pH greater buffer reasoning using mole ratios instead of direct calculations." },
                { q: "Which observation confirms that a solution is acting as a buffer rather than a weak acid alone?", a: "c", options: {a: "The pH is below 7", b: "The solution contains ions", c: "Small additions of acid cause minimal pH change", d: "The solution conducts electricity"}, exp: "Buffers are defined by their resistance to pH change, not by initial pH or conductivity. A weak acid alone will experience noticeable pH shifts when acid or base is added, but a buffer contains both a weak acid and its conjugate base, allowing neutralization reactions to limit pH change." },
                { q: "A solution is formed by adding excess strong base to a weak acid solution. Which species primarily determines the final pH?", a: "c", options: {a: "Undissociated weak acid", b: "Conjugate base of the weak acid", c: "Excess OH- ions", d: "Hydronium ions from water"}, exp: "When a strong base is added in excess, all available weak acid is neutralized first through stoichiometric reaction. Once the weak acid is fully consumed, the remaining strong base dictates the pH. At this point, equilibrium expressions for the weak acid are irrelevant because excess OH- overwhelms any basicity from the conjugate base." },
                { q: "What is the pH of a solution formed by mixing equal moles of strong acid and strong base?", a: "b", options: {a: "Less than 7", b: "Equals to 7", c: "Greater than 7", d: "Depends on concentration"}, exp: "When equal moles of a strong acid and a strong base react, they completely neutralize each other to form water and a neutral salt. Because neither species remains in excess and the salt does not affect pH, the final solution is neutral at 25° C." },
                { q: "A solution has a pOH of 3.75. What is the pH?", a: "b", options: {a: "3.75", b: "10.25", c: "7.00", d: "6.25"}, exp: "At 25°C the relationship is pH + pOH=14 which means 14-3.75=10.25. Because the pH is greater than 7, the solution is basic." },
                { q: "Which statement best explains why hydrochloric acid is classified as a strong acid?", a: "c", options: {a: "It has a low pH value", b: "It reacts vigorously with metals", c: "It fully ionizes in aqueous solution", d: "It has a high molar mass"}, exp: "A strong acid is defined by its extent of ionization, not by pH alone. Hydrochloric acid completely dissociates into ions when dissolved in water. This complete ionization leads to high conductivity and predictable acid behavior. Weak acids may still have low pH at high concentrations, so pH alone cannot define acid strength." },
                { q: "Which of the following describes an Arrhenius acid?", a: "c", options: {a: "A species that accepts a proton", b: "A species that donates a proton", c: "A species that increases [H+] in aqueous solution", d: "A species that donates an electron pair"}, exp: "Arrhenius acids increase the concentration of hydrogen ions [H+] in aqueous solution." },
                { q: "Which solution contains the stronger acid?", a: "c", options: {a: "0.1 M acetic acid", b: "0.1M HF", c: "0.1 M HCl", d: "0.1 M H_2CO_3"}, exp: "HCl is a strong acid and dissociates completely in water." },
                { q: "What is the correct Ka expression for the weak acid HA<-->H+ + A-?", a: "b", options: {a: "Ka=[HA]/[H+][A-]", b: "Ka=[H+][A-]/[HA]", c: "Ka=[HA][A-]/[H+]", d: "Ka=[H+]/[A-][HA]"}, exp: "Ka is the equilibrium constant for the ionization of a weak acid and is given by [H+][A-]/[HA]." },
                { q: "What is the pH of a solution with [H+]=1.0*10^-3 M?", a: "b", options: {a: "2", b: "3", c: "4", d: "5"}, exp: "pH = -log[H+]=-log(1.0*10^-3)=3" },
                { q: "What is the best estimate for the pH of a 1*10^-3 M HI(aq)solution at 25° C?", a: "a", options: {a: "pH=3", b: "pH=6", c: "pH=9", d: "pH=12"}, exp: "Substituting the value of 1*10^-3 M in the pH=-log[H+] would provide the pH value because HI is a strong acid and dissociates completely. Therefore, this would results in pH=-log[1*10^-3M]=3." },
                { q: "What is the best estimate for the pH of a 9.5*10^-4 M KOH(aq) solution at 25°C?", a: "d", options: {a: "pH=3", b: "pH=6", c: "pH=8", d: "pH=11"}, exp: "Substituting the value of 9.5*10^-4 M in the pOH=-log[OH-] would provide the pH value because KOH is a strong base and dissociates completely. Therefore, this would results in pOH=-log[9.5*10^-4]=3.0. In order to find pH, subtract the answer from 14 since pH+pOH=14. This leads to the answer 14-3=11." },
                { q: "2H_2O(l)<-->H_3O+(aq)+OH^-(aq) Kw=1.0*10^-14, Which of the following is correct about the provided reaction at 25°C?", a: "b", options: {a: "pOH=1.0*10^-14", b: "pH=7", c: "[H_3O+]=1.0*10^-14", d: "OH-=7.0M"}, exp: "Square rooting the value of Kw does not directly represent the value of pOH is 1*10^-7 M. The value of pH can be determined by substituting 1*10^-7 M in pH=-log[H_3)+] which gives the pH the value of 7." },
                { q: "Which of the following acids is the best conductor of electricity?", a: "a", options: {a: "HBr", b: "HF", c: "HCN", d: "HNO_2"}, exp: "HBr is the only strong acid listed, so it fully ionizes and conducts best." },
                { q: "A student initially prepared a solution of 20 mL of 0.002M NaOH(aq). After, the student added 10 mL of distilled water in the solution. Which of the following is the best estimate of the pH of the solution?", a: "c", options: {a: "4", b: "8", c: "11", d: "13"}, exp: "The resulting molarity after the addition of distilled water can be solved by using the formula MV=M_2V_2 which results in final molarity would equal to around 1*10^-3M which is [OH_]. Using the formula pOH=-log[OH-],pOH=3. Subtracting pOH from 14 would result in the pH which is 14-3=11." },
                { q: "Which of the following is amphoteric?", a: "b", options: {a: "H+", b: "NH_3", c: "CO_3 2-", d: "H_2SO_3"}, exp: "Amphoteric substances are those that can act as an acid or a base. NH_3 can be an acid and become NH_2- by losing a proton or it can act as a base and become NH_4+ by gaining a proton." },
                { q: "What is the ionization constant, Ka, for a weak monoprotic acid if a 0.20 molar solution has a pH of 5?", a: "a", options: {a: "5*10^-10", b: "1*10^-4", c: "2.5*10^-5", d: "4*10^-6"}, exp: "Since the pH=5, then [H+] and [A-]=1*10^-5. Substituting the values in the Ka=[H+][A-]/[HA] would be ka=(1*10^-5)(1*10^-5)/0.20=5*10^-10." },
                { q: "What would be the pH of the solution after 1.68 grams of HClO_3 is being added in 2 liters of distilled water?(molecular weight of HClO_3=84.0g)?", a: "b", options: {a: "1", b: "2", c: "3", d: "4"}, exp: "First find the moles of HCLO_3 that were being added which is 168g/84.0=0.02moles. Second, find the H+ concentration which is [H+]-0.02moles/2L=0.01M. Lastly, find the value of pH by using the formula pH=-log[H+] which is -log(0.01)=2." },
                { q: "Which of the following could be the species that is being titrated with KOH?", a: "d", options: {a: "HIO", b: "HIO_2", c: "HIO_3", d: "HIO_4"}, exp: "The acid with the greatest number of oxygen atoms is expected to be the strongest acid due to the electron density which affects the electronegativity. From the choices, HIO_4 has the greatest amount of oxygen atoms." },
                { q: "Which of the following is the strongest Bronsted-Lowry acid?", a: "d", options: {a: "2.15*10^-7", b: "8.6*10^-7", c: "2.3*10^-8", d: "6.6*10^-4"}, exp: "Larger Ka → stronger acid. 6.6×10^-4 is the largest Ka" },
                { q: "The value of Ka for H_2CO_3 is 4.3*10^-7. Which of the following is the value of Kb for HCO_3?", a: "d", options: {a: "K_3PO_4 Ka=7.52*10^-3", b: "HNO_2 Ka=4.0*10^-4", c: "H_2CO_3 Ka=4.3*10^-7", d: "HCOOH Ka=1.77*10^-4"}, exp: "The best choice for the buffer is when pKa is close to the value of pH. From the choices, choice d has a pKa value of 3.75 which was the closest value to pH of 4." },
                { q: "What is the ideal pKa for an indicator for a titration when pOH at the equivalence point is 8.7?", a: "b", options: {a: "2.6", b: "5.3", c: "6.4", d: "7.2"}, exp: "The ideal pKa for the indicator would be close to the value of pH. The pH of the equivalence point can be determined by subtracting 8.7 from 14 which results in pH=5.3." },
                { q: "If a solution has a hydrogen ion concentration [H+] of 1.0*10^-4 M, what is the pH of the solution, and is it acidic or basic?", a: "a", options: {a: "pH = 4.0, acidic", b: "pH=4.0, basic", c: "pH=10.0, acidic", d: "pH=10.0, basic"}, exp: "The formula for pH is pH=-log[H+]. Taking the negative logarithms of 1.0*10^-4 gives a pH of 4.0. Since any pH less than 7.0 at 25°C is considered acidic, the solution is acidic." },
                { q: "What is the conjugate base of the chemical species HSO_4-?", a: "b", options: {a: "H_2SO_4", b: "SO_4 2-", c: "H+", d: "OH-"}, exp: "A conjugate base is formed when an acid loses exactly one proton (H+). When HSO_4- donates its proton, it loses an H atom and its overall negative charge increases by one, leaving behind SO_4 2-." },
                { q: "Which of the following chemical species is classified as a strong acid in aqueous solutions?", a: "c", options: {a: "HF", b: "HC_2H_3O_2", c: "HCl", d: "H_2CO_3"}, exp: "Hydrochloric acid(HCl) is one of the six standard strong acids that completely ionizes into its component ions in water. Hydrofluoric acid(HF), acetic acid (HC_2H_3O_2), and carbonic acid (H_2CO_3) only partially ionize in water, classifying them as weak acids." }
            ],
            9: [
                { q: "At approximately what temperature does the reaction change from spontaneous to nonspontaneous?", a: "b", options: {a: "Below 200 K", b: "Around 400 K", c: "Around 600K", d: "It does not change"}, exp: "Spontaneity changes when ΔG = 0. Using ΔG=ΔH-ΔS and converting units consistently, the temperature breakdown is T=ΔH/ΔS=80,000J /200J/K=400K. Below this temperature ΔG is negative and the reaction is spontaneous; above it, the -T(ΔS) term overwhelms ΔH and ΔG." },
                { q: "Which reaction is spontaneous only at high temperature?", a: "b", options: {a: "ΔH < 0, ΔS > 0", b: "ΔH > 0, ΔS > 0", c: "ΔH < 0, ΔS < 0", d: "ΔH > 0, ΔS < 0"}, exp: "Positive ΔH and ΔS means enthalpy opposes spontaneity while entropy favors it. Increasing temperature magnifies the -TΔS term, eventually making ΔG negative." },
                { q: "A reaction has ΔH=-48kJ/mol and ΔS=-160J/(mol*K). Which statement is correct?", a: "b", options: {a: "Spontaneous at all temperatures", b: "Spontaneous only at low temperatures", c: "Spontaneous only at high temperatures", d: "Never spontaneous"}, exp: "Both ΔH and ΔS are negative. At low temperatures, the favorable enthalpy term dominates, keeping ΔG negative. As temperature increases, the -TΔS term becomes increasingly positive and eventually outweighs ΔH, making ΔG positive." },
                { q: "A reaction has ΔH=-35kJ/mol and ΔS=-90 J/(mol*K). Which statement is correct?", a: "b", options: {a: "Spontaneous at all temperatures", b: "Spontaneous only at low temperatures", c: "Spontaneous only at high temperatures", d: "Never spontaneous"}, exp: "With both ΔH and ΔS negative, spontaneity depends on temperature. At low temperature, the -TΔS term is small, so ΔG remains negative due to favorable ΔH. As temperature increases, -TΔS becomes positive and can outweigh ΔH, making ΔG positive." },
                { q: "Which process gives the largest increase in system entropy?", a: "b", options: {a: "Solid -> liquid", b: "Liquid -> gas", c: "Gas -> liquid", d: "Aqueous solution -> solid"}, exp: "Liquid-to-gas transitions dramatically increase particle freedom, volume, and accessible microstates. This produces the large positive entropy change among common phase changes." },
                { q: "A reaction has ΔH=-10kJ/mol and ΔS=+20 J/(mol*K). Which statement is correct?", a: "c", options: {a: "Spontaneous only at low temperatures", b: "Spontaneous only at high temperatures", c: "Spontaneous at all temperatures", d: "Never spontaneous"}, exp: "Negative ΔH and positive ΔS both favor spontaneity. In ΔG=ΔH-TΔS, both terms make ΔG negative at any temperature. Increasing temperature only strengthens the favorable -TΔS term, so the reaction remains spontaneous across all temperatures." },
                { q: "Why does equilibrium correspond to zero cell potential?", a: "b", options: {a: "ΔH equals zero", b: "ΔS equals zero", c: "No net driving force remains", d: "The salt bridge stops working"}, exp: "At equilibrium, ΔG = 0, meaning there is no thermodynamic driving force in either direction. Because ΔG and E° cells are linked (ΔG = -nFE°cell), the E°cell must also be zero. Electron flow still occurs microscopically but produces no net current." },
                { q: "Which condition guarantees that ΔG becomes more negative during reaction progress?", a: "b", options: {a: "Q increases", b: "Q decreases", c: "K increases", d: "ΔG changes"}, exp: "ΔG = ΔG° + RT ln Q. When Q decreases, ln Q becomes more negative, lowering ΔG. This increases the thermodynamic driving force. K and ΔG° are fixed at a given temperature and do not change during reaction progress." },
                { q: "A reaction has ΔH = +15kJ/mol and ΔS=+75J/(mol*K). Which conclusion is correct?", a: "c", options: {a: "The reaction is spontaneous at all temperatures", b: "The reaction is spontaneous only at high temperatures", c: "The reaction becomes spontaneous at temperatures above 200 K", d: "The reaction is never spontaneous"}, exp: "With both ΔH and ΔS positive, the reaction is endothermic but entropy-favored. At low temperatures, ΔH dominates and ΔG remains positive. As temperature increases, the -TΔS term becomes large enough to outweigh ΔH, making ΔG negative. This reaction is spontaneous only at sufficiently high temperatures." },
                { q: "A galvanic cell has not yet reached equilibrium. Which condition must be true?", a: "c", options: {a: "ΔG = 0", b: "E°cell = 0", c: "Q is not equal to K", d: "The salt bridge is not functioning"}, exp: "A system reaches equilibrium only when Q = K. If the cell does not reach equilibrium, Q must be different from K. Under those conditions, ΔG is not zero and E°cell is not zero, meaning the cell can still perform electrical work." },
                { q: "A reaction has ΔH=-20kJ/mol and ΔS = +40J/(mol*K). Which statement is correct?", a: "c", options: {a: "The reaction is spontaneous only at low temperatures", b: "The reaction is spontaneous only at high temperatures", c: "The reaction is spontaneous at all temperatures", d: "The reaction is never spontaneous"}, exp: "A negative ΔH favors spontaneity, and a positive ΔS also favors spontaneity. Since both terms contribute to making ΔG negative in ΔG = ΔH - TΔS, the reaction will be spontaneous at all temperatures. Increasing temperature only makes the -TΔS term more negative, further favoring spontaneity." },
                { q: "A reaction has ΔH < 0 and ΔS < 0. Which statement best describes the effect on increasing temperature on spontaneity?", a: "b", options: {a: "The reaction becomes more spontaneous", b: "The reaction becomes less spontaneous", c: "Temperature has no effect", d: "The reaction becomes spontaneous at all temperatures"}, exp: "When both ΔH and ΔS are negative, the reaction is spontaneous only at low temperatures. Increasing temperature increases the magnitude of the -TΔS term, which is positive in this case and works against spontaneity. As temperature rises, ΔG becomes less negative and can eventually become positive, making the reaction nonspontaneous." },
                { q: "Which observation best explains why ΔG cannot predict reaction direction at all time?", a: "c", options: {a: "ΔH changes with concentration", b: "ΔS depends on pressure", c: "Q changes as reactions proceed", d: "E°cell is temperature-dependent"}, exp: "ΔG° assumes standard conditions. As a reaction proceeds, concentrations change, altering Q. The actual spontaneity depends on ΔG = ΔG° + RT ln Q, making ΔG the correct predictor under real conditions." },
                { q: "A galvanic cell operates under nonstandard conditions where Q < 1. Which conclusion must be true?", a: "c", options: {a: "E°cell < E°cell", b: "ΔG > ΔG°", c: "E°cell > E°cell", d: "The cell is nonspontaneous"}, exp: "From the Nernst equation, E°cell = E° - (RT/nF) ln Q. When Q < 1, ln Q is negative, making the subtraction term negative and increasing the E°cell above the E°cell. This reflects greater driving force early in cell operation." },
                { q: "A reaction has ΔH=-55kJ/mol and ΔS=-150 J/(mol*K). Which statement best describes the reaction's spontaneity?", a: "b", options: {a: "Spontaneous at all temperatures", b: "Spontaneous only at low temperatures", c: "Spontaneous only at high temperatures", d: "Never spontaneous"}, exp: "Both ΔH and ΔS are negative. At low temperatures, the -TΔS term is small, so ΔG remains negative due to the large negative ΔH. As temperature increases, -TΔS becomes positive and eventually outweighs ΔH, making ΔG positive." },
                { q: "Which reaction would show the largest temperature dependence?", a: "d", options: {a: "Small ΔH, small ΔS", b: "Large ΔH, small ΔS", c: "Small ΔH, large ΔS", d: "Large ΔH, large ΔS"}, exp: "Large ΔH and ΔS values make ΔG highly sensitive to temperature changes. Small changes in T can flip the sign of ΔG, making spontaneity strongly temperature-dependent." },
                { q: "Which situation corresponds to chemical equilibrium?", a: "c", options: {a: "ΔG°=0", b: "E°cell = 0", c: "ΔG=0", d: "Q = 1"}, exp: "Equilibrium occurs when ΔG = 0 under the current conditions. ΔG° may be positive or negative at equilibrium. E°cell refers only to standard conditions. Q equals K at equilibrium, not necessarily 1." },
                { q: "Why does increasing temperature favor reactions with positive ΔS?", a: "c", options: {a: "It lowers ΔH", b: "It increases molecular mass", c: "It increases the magnitude of TΔS", d: "It lowers activation energy"}, exp: "If ΔG = ΔH - TΔS, increasing temperature increases the TΔS term. When ΔS is positive, this makes ΔG more negative, favoring spontaneity. Temperature does not change ΔH directly and does not affect activation energy or mass." },
                { q: "Which condition must be true for a reaction to be spontaneous under the current conditions?", a: "b", options: {a: "ΔG° < 0", b: "ΔG < 0", c: "ΔH < 0", d: "ΔS > 0"}, exp: "Spontaneity depends on the sign of ΔG under the actual conditions, not ΔG°. ΔG° only describes standard conditions. A reaction may have ΔG° > 0 and still be spontaneous if ΔG < 0 due to nonstandard concentrations. Enthalpy and entropy alone never guarantee spontaneity without considering temperature and conditions." },
                { q: "A reaction has ΔH=+30 kJ/mol and ΔS=+60 J/(mol*K). Which statement is correct?", a: "c", options: {a: "The reaction is spontaneous at all temperatures", b: "The reaction is spontaneous only at low temperatures", c: "The reaction is spontaneous only at high temperatures", d: "The reaction is never spontaneous"}, exp: "With both ΔH and ΔS positive, spontaneity depends on temperature. At low temperatures, the TΔS is small so ΔG remains positive due to the positive ΔH. As temperature increases, TΔS grows large enough to outweigh ΔH, making ΔG negative." },
            ]
        };
...
class Level4 extends Phaser.Scene {
    ...
    create() {
        ...
        for (let i = 0; i < 5; i++) {
            let note = this.notes.create(rightX, topY + i * spacingY, "onenote").setScale(0.18);
            note.body.setAllowGravity(false);
            note.body.immovable = true;
        }
