    ...
    create() {
        ...
        this.chemQuestions = {
            ...
            5: [
                ...
                { q: "Which factor directly increases the rate of a chemical reaction?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "Why does increasing the concentration of a reactant typically increase the reaction rate?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "A reaction is first order in A. If [A]=0.40M and the rate constant k=0.20 s^-1, what is the rate?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "Which best defines the activation energy of a reaction?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "Given the rate law Rate=k[A][B]^2, what is the order of the reaction?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "C_12H_22O_11(aq) + H_2O(l)->2C_6H_12O_6(aq) The chemical equation shown above represents the hydrolysis of sucrose. Under certain conditions, the rate is directly proportional to the concentration of sucrose. Which statement supports how a change in conditions can increase the rate of this reaction?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "CH_3I+NaOH ->CH_3OH+NaI. The rate of the expression represented by the chemical equation shown above is expressed as rate = k[CH_3I][NaOH]. Based on this information, which of the following claims is correct?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" }
            ],
            6: [
