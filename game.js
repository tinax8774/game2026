...
class Level1 extends Phaser.Scene {
    ...
    create() {
        ...
        this.chemQuestions = {
            ...
            3: [
                { q: "Which intermolecular force is primarily responsible for the usually high boiling point of hydrogen fluoride(HF) compared with other hydrogen halides?", a: "", options: {a: "London-dispersion forces", b: "Dipole-dipole interactions", c: "Hydrogen bonding", d: "Ion-dipole forces"}, exp: "" },
                { q: "Two compounds, A and B, have equal molar mass. A is nonpolar and spherical;B is a long chain, nonpolar molecule. At the same temperature, which is expected to have the highest boiling point and why?", a: "", options: {a: "A, because spherical molecules rotate faster", b: "A, because lower surface area reduces vapor pressure", c: "B, because larger surface area reduces vapor pressure", d: "B, because chain molecules form hydrogen bonds"}, exp: "" },
                { q: "Which of the following best explains why ionic solids typically have much higher melting points than molecular solids?", a: "", options: {a: "Ionic solids are always covalently bonded networks", b: "Ionic solids are held by strong electrostatic attractions between ions", c: "Molecular solids have higher molar masses than ionic solids", d: "Ionic solids have weaker lattice energies"}, exp: "" },
                { q: "At constant temperature, which change will increase the vapor pressure of a volatile liquid in a closed container?", a: "", options: {a: "Add the immiscible nonvolatile solute to the liquid", b: "Increase the surface area of the liquid while keeping amount constant", c: "Decrease the temperature of the system", d: "Remove some vapor from the gas phase and allow system to re-equilibrate"}, exp: "" },
                { q: "Which description of an ideal gas is consistent with the kinetic molecular theory?", a: "", options: {a: "Gas molecules attract each other strongly at all distances", b: "Collisions between molecules are perfectly elastic and molecules occupy negligible volume.", c: "Gas molecules undergo only inelastic collisions and lose energy each collision", d: "Molecules move slower at higher temperature"}, exp: "" },
                { q: "Which gas will deviate most from ideal behavior at high pressure and moderate temperature?", a: "", options: {a: "Helium, because it has the smallest molar mass", b: "Nitrogen, because it forms diatomic molecules", c: "Carbon dioxide, because it is more polarizable and has stronger intermolecular attractions", d: "Neon, because noble gases are always unideal"}, exp: "" },
                { q: "Dalton's law of partial pressures states that tin a mixture of nonreacting gases at constant volume and temperature, the total pressure equals:", a: "", options: {a: "the sum of partial pressures of individual gases", b: "the product of partial pressures", c: "the pressure of the most abundant gas only", d: "the average of the partial pressure"}, exp: "" },
                { q: "Which experiment technique separates a mixture based on differences in boiling point?", a: "", options: {a: "Chromotography", b: "Distillation", c: "Filtration", d: "Centrifugation"}, exp: "" },
                { q: "Which change will most directly increase the rate of diffusion of a gas at constant?", a: "", options: {a: "Increasing molar mass", b: "Decreasing temperature", c: "Increasing temperature", d: "Increasing intermolecular attractions"}, exp: "" },
                { q: "Which condition will increase gas solubility in a liquid?", a: "", options: {a: "Increasing temperature for most gases", b: "Decreasing pressure", c: "Increasing pressure of the gas above the liquid", d: "Decreasing the polarity of the solvent"}, exp: "" },
                { q: "Which statement best explains why water and ethanol are completely miscible, but water and hexane are not?", a: "", options: {a: "Ethanol and hexane have similar molar masses", b: "Hexane can form hydrogen bonds with water, while hexane cannot", c: "Hexane has stronger London dispersion forces", d: "Water has a higher boiling point than ethanol"}, exp: "" },
                { q: "A liquid has a low vapor pressure, high viscosity, and large heat of vaporization. Which conclusion is most justified?", a: "", options: {a: "The liquid has strong covalent bonds", b: "The liquid contains ions", c: "Intermolecular attractions between molecules are strong", d: "The molecules are very small"}, exp: "" },
                { q: "A real gas shows Z < 1 at moderate pressure but Z > 1 at very high pressure. What does this reveal?", a: "", options: {a: "Attractive forces dominate at all pressure", b: "Particle volume dominates at all pressures", c: "Attractions dominate first, then repulsions and volume effects", d: "The gas becomes ideal at high pressure"}, exp: "" },
                { q: "A student measures the boiling point of four liquids at 1 atm and observes the order: W > X > Y > Z?", a: "", options: {a: "Vapor pressure at 25° C", b: "Strength of intermolecular forces", c: "Diffusion of vapor", d: "Entropy of vaporization"}, exp: "" },
                { q: "Rank the following gases by increasing rate of effusion: CO_2, He, N_2", a: "", options: {a: "CO_2 < N_2 < He", b: "He < N_2 < CO_2", c: "N_2 < CO_2 < He", d: "CO_2 < He < N_2"}, exp: "" },
                { q: "Which type of intermolecular force is present in all molecular substances?", a: "", options: {a: "Hydrogen bonding", b: "Ion-dipole forces", c: "London dispersion forces", d: "Dipole-dipole forces"}, exp: "" },
                { q: "What causes water to have a relatively high boiling point compared to similar-sized molecules?", a: "", options: {a: "Hydrogen bonding", b: "Covalent bonding", c: "", d: "Ion-ion interactions"}, exp: "" },
                { q: "Which of the following substances is most likely to be miscible with water?", a: "", options: {a: "CH_4", b: "NH_3", c: "CCl_4", d: "I_2"}, exp: "" },
                { q: "Which compound will have the highest vapor pressure at 25°C?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "Which property would increase when a substance has stronger intermolecular forces?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "Which of the following pure substances has the highest boiling point?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "The boiling point of HF (20°C) is much higher than that of HCl (_85°C). Which of the following best explains this difference?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "Two identical flasks at the same temperature contain equal volumes of two different liquids. Liquid A has a higher vapor pressure than Liquid B. Which of the following statements is true?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "Which of the following substances will sublime at room temperature and pressure?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "Which of the following pairs of liquids is most likely to be miscible?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "A paper chromatography experiment is performed using a nonpolar solvent as the mobile phase and a polar paper as the stationary phase. A solute is spotted on the baseline. Which of the following is true regarding a highly polar solute?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "Which statement correctly describes the behavior of real gases compared to ideal gases?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "A sample of N_2 gas and a sample of O_2 gas are kept at the same temperature. Which of the following statements is true?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "A 5.0L flask contains 0.20 mol of He gas and 0.30 mol of Ne gas at a certain temperature. What is the partial pressure of the He gas if the total pressure is 2.5 atm?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "What is the density of O_2 gas at standard temperature and pressure (STP)?(Molar mass of O_2=32.0g/mol, standard volume=22.4L/mol)", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "A student measures the absorbance of a colored solution using a spectrophotometer. If the concentration of the solution is doubled, what happens to the absorbance, assuming the path length remains constant?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "Which of the following properties is characteristic of network covalent solids like diamond (C) and quartz (SiO_2)?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "Which of the following ionic compounds is expected to have the highest lattice energy?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" },
                { q: "When LiCl is dissolved in water, the temperature of the water increases. Which of the following statements about the dissolution process is accurate?", a: "", options: {a: "", b: "", c: "", d: ""}, exp: "" }
            ],
            4: [
