    ...
    create() {
        ...
        this.chemQuestions = {
            ...
            5: [
                ...
                { q: "If products are lower in energy than reactants, which statement is correct?", a: "d", options: {a: "ΔG>0 and K<1", b: "ΔG<0 and K>1", c: "ΔG=0 and K=1", d: "Reaction is irreversible"}, exp: "Lower-energy products indicate a thermodynamically favorable reaction. This corresponds to a negative ΔH, meaning the reaction favors products at equilibrium and K is greater than 1." },
                { q: "If ΔG=0, what can be concluded about equilibrium?", a: "b", options: {a: "Reaction does not occur", b: "Reactants are favored", c: "Products are formed", d: "Neither sides is favored"}, exp: "When ΔG equals zero, the system is at equilibrium under standard conditions. Reactants and products are equally favored, and K equals 1." },
                ...
                { q: "A reaction is first order in A. If [A]=0.40M and the rate constant k=0.20 s^-1, what is the rate?", a: "d", options: {a: "0.08 M/s", b: "0.50 M/s", c: "0.20 M/s", d: "0.80 M/s"}, exp: "For a first-order reaction: Rate=k[A]=(0.20 s^-1)(0.40M)=0.08 M/s" },
            ...
            6: [
                ...
                { q: "Which situation ensures that temperature changes but internal energy does not?", a: "a", options: {a: "Isothermal expansion of an ideal gas", b: "Isobaric heating of a liquid", c: "Phase change at constant pressure", d: "Adiabatic compression"}, exp: "For an ideal gas, internal energy depends only on temperature. In an isothermal process temperature remains constant, so internal energy does not change, even though heat and work may be exchanged." },
            ...
            7: [
                ...
                { q: "Which of the following would lead to a reduction in the value of the equilibrium constant?", a: "a", options: {a: "Decrease the temperature", b: "Increase the temperature", c: "Increase the concentration of I_2", d: "Decrease the pressure"}, exp: "Changing the pressure or the concentration of the reactant and product will not result in a change for the value of equilibrium constant. Since the reaction is endothermic, decreasing the temperature will cause a shift to the left resulting in an increase of reactant and increasing the denominator value of the equilibrium constant. Therefore, it decreases the value of the equilibrium constant." },
            ...
            8: [
                ...
                { q: "Which buffer composition best resists a large addition of strong acid?", a: "c", options: {a: "High concentration, equal HA and A-", b: "Dillute solution with excess A-", c: "Concentrated solution with excess A-", d: "Concentrated solution with excess HA"}, exp: "Buffer resistance depends on both capacity (total moles of buffering species) and directional composition. To neutralize added acid, conjugate base must be present, and higher total concentration increases capacity. A concentrated buffer with excess A= provides the greatest resistance to a large acid addition." },
                ...
                { q: "Which of the following describes an Arrhenius acid?", a: "c", options: {a: "A species that accepts a proton", b: "A species that donates a proton", c: "A species that increases [H+] in aqueous solution", d: "A species that denotes an electron pair"}, exp: "Arrhenius acids increase the concentration of hydrogen ions [H+] in aqueous solution." },
                ...
                { q: "Which of the following acids is the best conductor of electricity?", a: "a", options: {a: "HBr", b: "HF", c: "HCN", d: "HNO_2"}, exp: "HBr is the only strong acid within the choices which means that HBr will dissociate completely into ions allowing the acid to be the best conductor of electricity within the choices." },
                ...
                { q: "Which of the following could be the species that is being titrated with KOH?", a: "b", options: {a: "1", b: "2", c: "3", d: "4"}, exp: "First find the moles of HCLO_3 that were being added which is 168g/84.0=0.02moles. Second, find the H+ concentration which is [H+]-0.02moles/2L=0.01M. Lastly, find the value of pH by using the formula pH=-log[H+] which is -log(0.01)=2." },
                { q: "What would be the pH of the solution after 1.68 grams of HClO_3 is being added in 2 liters of distilled water?(molecular weight of HClO_3=84.0g)?", a: "d", options: {a: "HIO", b: "HIO_2", c: "HIO_3", d: "HIO_4"}, exp: "The acid with the greatest number of oxygen atoms is expected to be the strongest acid due to the electron density which affects the electronegativity. From the choices, HIO_4 has the greatest amount of oxygen atoms." },
                { q: "Which of the following is the strongest Bronsted-Lowry acid?", a: "c", options: {a: "2.15*10^-7", b: "8.6*10^-7", c: "2.3*10^-8", d: "6.6*10^-4"}, exp: "Since H_2CO_3 and HCO_3- are conjugates, Kb=Kw/Ka=(1*10^-14)/(4.3*10^-7)=2.3*10^-8." },
            ...
            9: [
                ...
                { q: "At approximately what temperature does the reaction change from spontaneous to nonspontaneous?", a: "b", options: {a: "Below 200 K", b: "Around 400 K", c: "Around 600K", d: "It does not change"}, exp: "Spontaniety changes when ΔG = 0. Using ΔG=ΔH-ΔS and converting units consistently, the temperature breakdown is T=ΔH/ΔS=80,000J /200J/K=400K. Below this temperature ΔG is negative and the reaction is spontaneous; above it, the -T(ΔS) term overwhelms ΔH and ΔG." },
                ...
                { q: "Which process gives the largest increase in system entropy?", a: "b", options: {a: "Solid -> liquid", b: "Liquid -> gas", c: "Gas -> liquid", d: "Aqeous solution -> solid"}, exp: "Liquid-to-gas transitions dramatically increase particle freedom, volume, and accessible microstates. This produces the large positive entropy change among common phase changes." },
                ...
                { q: "A galvanic cell has not yet reached equilibrium. Which condition must be true?", a: "c", options: {a: "ΔG = 0", b: "E°cell = 0", c: "Q is not equal to K", d: "ΔG = 0"}, exp: "A system reaches equilibrium only when Q = K. If the cell does not reach equilibrium, Q must be different from K. Under those conditions, ΔG is not zero and E°cell is not zero, meaning the cell can still perform electrical work." },
                ...
                { q: "Which conditions must be true for a reaction to be spontaneous under any set of conditions?", a: "b", options: {a: "ΔG° < 0", b: "ΔG < 0", c: "ΔH < 0", d: "ΔS > 0"}, exp: "Sponteneity depends on the sign of ΔG under the actual conditions, not ΔG°. ΔG° only describes standard conditions. A reaction may have ΔG° > 0 and still be spontaneous if ΔG < 0 due to nonstandard concentrations. Enthalpy and entropy alone never guarantee spontaneity without considering temperature and conditions." },
