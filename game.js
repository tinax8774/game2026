...
class InstructionScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(40, 500, "Remember: _ and a number means a subscript and then the number following the ^ is charged", {fontFamily: 'Nunito', fontSize: "23px", fill: "black" });
