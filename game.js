...
class Level1 extends Phaser.Scene {
    ...
    create() {
        ...
        this.chemQuestions = {
            ...
            7: [
                { q: "Chemical equilibrium is most likely analogous to which physical situation?", a: "c", options: {a: "A ball rolling downhill", b: "A pendulum swinging", c: "A book resting on a table", d: "A car accelerating"}, exp: "" },
                { q: "A system at equilibrium is disturbed, and both forward and reverse reaction rates increase, yet equilibrium position does not change. Why does this not violate Le Chatelier's principle?", a: "c", options: {a: "Le Chatelier principle applies only to gases", b: "Le Chatelier predicts rate changes", c: "Rate changes alone do not imply position change", d: "Equilibrium constants are unaffected"}, exp: "" },
                { q: "A reaction has a very small K, yet the product concentration is nonzero at equilibrium. Which statement best explains this?", a: "b", options: {a: "Reaction is incomplete", b: "Equilibrium is dynamic", c: "Products are unstable", d: "K does ot represent equilibrium"}, exp: "" },
                ...
                { q: "A student observes that Q = K at a single instant. What can be concluded with certainty?", a: "c", options: {a: "A system has been at equilibrium for a long time", b: "The system will not shift", c: "The system is at equilibrium at that constant", d: "The reaction has stopped"}, exp: "" },
                { q: "A system is at equilibrium. Reactants are added, but equilibrium concentrations of both reactants and products increase after re-equilibration. Which conclusion is logically valid?", a: "d", options: {a: "The reaction is endothermic", b: "ΔN > 0", c: "K increased", d: "None of the above"}, exp: "" },
                { q: "A reaction has K=1.0*10^-3 at 25°C. Which statement must be true?", a: "b", options: {a: "The reaction is slow", b: "Reactants dominate at equilibrium", c: "Products never form", d: "The reaction is exothermic"}, exp: "" },
                { q: "Which conclusion can be drawn if a reaction reaches the same equilibrium composition from three different starting mixtures?", a: "d", options: {a: "Reaction is fast", b: "Reaction is endothermic", c: "Equilibrium is kinetically controlled", d: "Equilibrium position is thermodynamically defined"}, exp: "" },
                { q: "A system is at equilibrium. A student adds reactant and immediately measures concentrations before any shift occurs. Which statement must be true at that instant?", a: "b", options: {a: "Q = K", b: "Q < K", c: "Q > K", d: "Equilibrium has shifted"}, exp: "" },
                { q: "Two experiments of the same reaction are conducted at the same temperature. Both reach equilibrium, but Experiment 1 has a larger product-to-reactant ratio than Experiment 2. Which conclusion is valid?", a: "d", options: {a: "Experiment 1 has a larger K", b: "Experiment 2 has a larger K", c: "The two experiments must have different K values", d: "Neither experiment changed K"}, exp: "" },
                ...
                { q: "Which change causes an equilibrium shift only because concentrations change, not because pressure changes?", a: "d", options: {a: "Compressing a gas mixture", b: "Adding inert gas at constant pressure", c: "Adding inert gas at constant volume", d: "Removing a reactant from solution"}, exp: "" },
                { q: "A reaction mixture is prepared with reactants only and then sealed at constant temperature. Which statement must be true before equilibrium is reached?", a: "c", options: {a: "Product concentration remains zero", b: "Reverse reaction rate is greater than forward rate", c: "Forward reaction rate is greater than reverse rate", d: "Concentrations remain constant"}, exp: "" },
                { q: "Which change will increase the value of KKK for an endothermic reaction?", a: "b", options: {a: "Decreasing temperature", b: "Increasing temperature", c: "Adding catalyst", d: "Increasing pressure"}, exp: "" },
                { q: "If a reaction mixture has Q=4.5 Q=4.5 Q=4.5 and K=1.2 K=1.2 K=1.2, what will occur?", a: "b", options: {a: "The reaction will shift right", b: "The reaction will shift left", c: "The reaction is at equilibrium", d: "The reaction will stop"}, exp: "" },
                { q: "Which change will not shift the equilibrium position of a system?", a: "c", options: {a: "Changing concentration", b: "Changing temperature", c: "Adding a catalyst", d: "Changing pressure (gaseous system)"}, exp: "" },
                { q: "What does it mean for a chemical reaction to be at dynamic equilibrium?", a: "b", options: {a: "The reaction has stopped completely", b: "The forward and reverse reactions occur at the same rate", c: "The concentrations of reactants and products are equal", d: "Only products are present"}, exp: "" },
                { q: "Which observation indicates that a chemical system has reached equilibrium?", a: "c", options: {a: "Concentrations of all species becomes zero", b: "Gas bubbles are no longer produced", c: "The concentrations of all species remain constant over time", d: "The reaction mixture becomes colorless"}, exp: "" },
                { q: "For the reaction: N_2(g)+3H_2(g)<-->2NH_3(g)+heat  Which change will shift the equilibrium to the right?", a: "b", options: {a: "Increasing temperature", b: "Removing NH_3", c: "Decreasing pressure", d: "Adding a catalyst"}, exp: "" },
                { q: "In the exothermic reaction: 2NO(g)+O_2(g)<-->2NO-2(g), which happens if temperature is increased?", a: "c", options: {a: "Equilibrium shifts right", b: "No change occurs", c: "Equilibrium shifts left", d: "The reaction stops"}, exp: "" },
                { q: "A student says that increasing pressure always favors the product side. Is this true?", a: "c", options: {a: "Yes, pressure increases always favor products", b: "No, pressure only affects solids", c: "No, it depends on the number of moles of gas", d: "Yes, if the reaction is exothermic"}, exp: "" },
                { q: "N_2(g)+3H_2(g)<-->2NH_3(g), Give the reaction above, what is the equilibrium constant, Kc?", a: "c", options: {a: "Kc=[N_2][H_2]^3/[2NH_3]^2", b: "Kc=[NH_3]/[H_2][N_2]", c: "Kc=[NH_3]^2/[H_2]^3[N_2]", d: "Kc=[N_2][H_2]/[NH_3]"}, exp: "" },
